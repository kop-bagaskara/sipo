    ...
    @section('content')
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="header-right d-flex flex-wrap justify-content-end">
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#exampleModal"> Add Jabatan </button>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="" style="font-size: 15px;">
                            <table id="datatable-jabatan" class="table table-responsive-md"
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <form class="submitJabatan" id="submitJabatan">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="text" name="id_jabatan" id="id_jabatan" class="form-control" hidden>
    ...
    @section('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                var datatable = $('#datatable-jabatan').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                ...
                var routeSubmitUser = "{{ route('master.jabatan-data-submit') }}";

                $('#submitJabatan').submit(function(e) {
                ...
                var routeEditUser = "{{ route('master.jabatan-data-detail', ['id' => 'ID_PLACEHOLDER']) }}";
                ...
                $('body').on('click', '.delete-data', function() {
                    var id = $(this).data('id');
                    var url = "{{ route('master.delete-master-jabatan-data', ['id' => 'ID_PLACEHOLDER']) }}";
