...
<head>
    ...
    <link href="{{ asset('sipo_krisan/public/news/plugins/select2/dist/css/select2.min.css') }}" rel="stylesheet" type="text/css" />
...
<body>
            ...
            <div class="controls">
                ...
                <div class="jump-to-page" style="display: flex; align-items: center; gap: 5px; margin-left: 15px;">
                    <input type="number" id="jumpToPageInput" class="form-control"
                           ...
                           min="1" max="{{ $totalPages }}" placeholder="No.">
    ...
    <script>
        ...
        function goToPage(pageNum, keyword = null) {
            ...
            let url = '{{ route("ebook-pkb.index") }}?page=' + pageNum;
            if (keyword) {
