            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body" id="dashboardTabs">
                        ...
                        <button class="nav-link active btn btn-info w-100 text-left" id="security-tab" data-bs-toggle="tab"
                        ...
                        <button class="nav-link active btn btn-info w-100 text-left" id="overview-tab" data-bs-toggle="tab"
                        ...
                        <button class="nav-link btn btn-info w-100 text-left" id="ppic-tab" data-bs-toggle="tab"
                        ...
                        <button class="nav-link btn btn-info w-100 text-left" id="prepress-tab" data-bs-toggle="tab"
                        ...
                        <button class="nav-link btn btn-info w-100 text-left" id="development-tab" data-bs-toggle="tab"
                        ...
                        <button class="nav-link btn btn-info w-100 text-left" id="supplier-tab" data-bs-toggle="tab"
                        ...
                        <br>
                        <button class="nav-link btn btn-info w-100 text-left" id="security-tab" data-bs-toggle="tab"
                            data-bs-target="#security" type="button" role="tab" aria-controls="security"
                            aria-selected="true">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="dashboardTabContent">
                                            ...
                                            <div class="card-header bg-info text-white">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h4 class="card-title mb-0 text-white">
                                                        <i class="mdi mdi-shield-account mr-2"></i>
                                                        Dashboard Keamanan - {{ auth()->user()->name }}
                                                    </h4>
                                                    <div>
                                                        <span class="badge badge-light mr-2">Portal Keamanan</span>
                                                        <span class="badge badge-info">Update Real-time</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-md-3">
                                                        <div class="card bg-info text-white">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0" id="securityTotalChecklists">0</h3>
                                                                <small>Total Daftar Periksa</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="card bg-warning text-white">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0" id="securityCompletedChecklists">0</h3>
                                                                <small>Selesai</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="card bg-info text-white">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0" id="securityPendingChecklists">0</h3>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card bg-info text-white">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0" id="securityTodayChecklists">0</h3>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-2">
                                                                        <a href="{{ route('security.vehicle-checklist.create') }}" class="btn btn-primary btn-block">
                                                                            <i class="mdi mdi-plus"></i> Daftar Periksa Kendaraan
                                                                        </a>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <a href="{{ route('security.goods-movement.create') }}" class="btn btn-success btn-block">
                                                                            <i class="mdi mdi-truck"></i> Pergerakan Barang
                                                                        </a>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <a href="{{ route('security.daily-activity.create') }}" class="btn btn-info btn-block">
                                                                            <i class="mdi mdi-clipboard-text"></i> Aktivitas Harian
                                                                        </a>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <a href="{{ route('hr.reports.security') }}" class="btn btn-warning btn-block">
                                                                            <i class="mdi mdi-chart-line"></i> Laporan
                                                                        </a>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <button class="btn btn-secondary btn-block" onclick="refreshSecurityData()">
                                                                            <i class="mdi mdi-refresh"></i> Segarkan
                                                                        </button>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <a href="{{ route('hr.security-master.index') }}" class="btn btn-dark btn-block">
                                                                            <i class="mdi mdi-account-group"></i> Manajemen Pengguna
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <h6 class="card-title mb-0">
                                                                    ...
                                                                    Daftar Periksa Kendaraan Terbaru
                                                                </h6>
                                                            </div>
                                                            <div class="card-body p-0">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover mb-0" id="securityVehicleTable">
                                                                        ...
                                                                        <tbody id="securityVehicleTableBody">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <h6 class="card-title mb-0">
                                                                    <i class="mdi mdi-truck mr-2"></i>
                                                                    Pergerakan Barang Terbaru
                                                                </h6>
                                                            </div>
                                                            <div class="card-body p-0">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover mb-0" id="securityGoodsTable">
                                                                        <thead class="thead-light">
                                                                            <tr>
                                                                                <th>No. Urut</th>
                                                                                <th>Tipe</th>
                                                                        ...
                                                                        <tbody id="securityGoodsTableBody">
                                                                            <!-- Data will be loaded via AJAX -->
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                            ...
                                                            <div class="col-12 mb-2">
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <strong
                                                                            class="text-primary">{{ $machine['name'] }}</strong>
                                                                        <small
                                                                            class="text-muted d-block">{{ $machine['code'] }}</small>
                                                                    </div>
                                                                    <div class="text-right">
                                                                        <span
                                                                            class="badge badge-{{ $machine['finished_count'] > 50 ? 'danger' : ($machine['finished_count'] > 30 ? 'warning' : 'success') }}">
                                                            ...
                                                            <div class="col-12 mb-2">
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <strong
                                                                            class="text-primary">{{ $order['jo'] }}</strong>
                                                                        <small
                                                                            class="text-muted d-block">Total Produksi: {{ number_format($order['total_production'] ?? 0, 0) }}</small>
                                                                    </div>
                                                                    <div class="text-right">
                                                                        <span
                                                                            class="badge badge-{{ $order['order_count'] > 20 ? 'danger' : ($order['order_count'] > 10 ? 'warning' : 'success') }}">
                                                                            {{ $order['order_count'] }} Pesanan
                                                                        </span>
                                                                        <small
                                                                            class="text-muted d-block">{{ $order['source'] }}</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                        ...
                                                        @foreach ($todayPlans as $plan)
                                                            <div class="d-flex align-items-center justify-content-between p-3 bg-light rounded mb-2 job-item {{ $plan->flag_status }}"
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div style="min-width: 0; flex: 1;">
                                                                        <h6 class="font-size-14 text-truncate">
                                                                            {{ $plan->MaterialName ?? $plan->code_item }}
                                                                        </h6>
                                                                        <h6 class="text-info d-block">
                                                                            {{ $plan->wo_docno }}</h6>
                                                                ...
                                                                <div class="text-right"
                                                                    ...
                                                                    <h6 class="font-weight-bold d-block text-truncate">
                                                                        {{ $plan->machine->Description ?? $plan->code_machine }}
                                                                    </h6>
                                                                    ...
                                                                    @if ($plan->delivery_date)
                                                                        <small class="text-warning d-block text-truncate"
                                                                            style="max-width: 150px;">Delivery:
                                                                            {{ $plan->delivery_date }}</small>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        @endforeach
                            ...
                            <!-- Development Full Dashboard Tab -->
                                        ...
                                        <div class="card border-left-success">
                                            <div class="card-header bg-success text-white">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div>
                                                        <span class="badge badge-light mr-2">Development</span>
                                                        <span class="badge badge-info">Real-time Updates</span>
                                                        <button class="btn btn-sm btn-light ml-2" onclick="refreshDevData()">
                                            ...
                                            <div class="card-body">
                                                <!-- Alert untuk job urgent -->
                                                <div class="alert alert-warning alert-dismissible fade show" id="urgentAlert" style="display: none;">
                                                    <i class="mdi mdi-alert-circle mr-2"></i>
                                                    <strong>Peringatan!</strong> Ada <span id="urgentCount">0</span> job urgent yang perlu perhatian segera.
                                                    <button type="button" class="close" data-dismiss="alert">
                                                        <span>&times;</span>
                                                    </button>
                                                </div>

                                                <!-- Development Statistics Row -->
                                                <div class="row mb-4">
                                                    <div class="col-md-3">
                                                        <div class="card bg-primary text-white">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0" id="devTotalJobs">0</h3>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card bg-warning text-white">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0" id="devDraftJobs">0</h3>
                                                                <small>Draft</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="card bg-info text-white">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0" id="devInProgressJobs">0</h3>
                                                                <small>In Progress</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="card bg-success text-white">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0" id="devCompletedJobs">0</h3>
                                                                <small>Completed</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card bg-light">
                                                            <div class="card-body text-center">
                                                                ...
                                                                <h3 class="text-info" id="avgLeadTime">0 hari</h3>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card bg-light">
                                                            <div class="card-body text-center">
                                                                <h6 class="text-muted">Overdue Jobs</h6>
                                                                <h3 class="text-danger" id="overdueJobs">0</h3>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="card bg-light">
                                                            <div class="card-body text-center">
                                                                <h6 class="text-muted">Today's Jobs</h6>
                                                                <h3 class="text-primary" id="todayJobs">0</h3>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <h6 class="card-title mb-0">
                                                                    <i class="mdi mdi-alert-circle mr-2"></i>
                                                                    Jobs Memerlukan Perhatian
                                                                </h6>
                                                            </div>
                                                            <div class="card-body p-0">
                                                                <div id="attentionJobsList" style="max-height: 400px; overflow-y: auto;">
                                                                    <div class="text-center p-4">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-2">
                                                                        <button class="btn btn-primary btn-block" onclick="refreshDevData()">
                                                                            <i class="mdi mdi-refresh"></i> Refresh
                                                                        </button>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <button class="btn btn-success btn-block" onclick="exportDevData()">
                                                                            <i class="mdi mdi-download"></i> Export
                                                                        </button>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <button class="btn btn-info btn-block" onclick="filterUrgentJobs()">
                                                                            <i class="mdi mdi-alert"></i> Urgent Only
                                                                        </button>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <button class="btn btn-warning btn-block" onclick="filterTodayJobs()">
                                                                            <i class="mdi mdi-calendar-today"></i> Hari Ini
                                                                        </button>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <button class="btn btn-secondary btn-block" onclick="showAllJobs()">
                                                                            <i class="mdi mdi-eye"></i> Semua
                                                                        </button>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <a href="/sipo/development/rnd-workspace" class="btn btn-dark btn-block">
                                                                            <i class="mdi mdi-open-in-new"></i> Full View
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <canvas id="devTrendChart" height="200"></canvas>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

                                                <!-- Development Jobs Table -->
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <div class="d-flex justify-content-between align-items-center">
                                                                    <h5 class="card-title mb-0">
                                                                        <i class="mdi mdi-format-list-bulleted mr-2"></i>
                                                                        Recent Development Jobs
                                                                    </h5>
                                                                    <div class="btn-group" role="group">
                                                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="filterByStatus('DRAFT')">Draft</button>
                                                                        <button type="button" class="btn btn-sm btn-outline-info" onclick="filterByStatus('IN_PROGRESS')">In Progress</button>
                                                                        <button type="button" class="btn btn-sm btn-outline-success" onclick="filterByStatus('COMPLETED')">Completed</button>
                                                                        <button type="button" class="btn btn-sm btn-outline-secondary" onclick="showAllJobs()">All</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card-body p-0">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover mb-0" id="devJobsTable">
                                                                        <thead class="thead-light">
                                                                            <tr>
                                                                                <th>Job Code</th>
                                                                                <th>Customer</th>
                                        ...
                                        <div class="card border-left-success">
                                            <div class="card-header bg-info text-white">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <h4 class="card-title mb-0 text-white">
                                                        <i class="mdi mdi-truck mr-2"></i>
                                                        Dashboard Supplier - {{ auth()->user()->name }}
                                                    </h4>
                                                    <div>
                                                        <span class="badge badge-light mr-2">Supplier Portal</span>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <div class="d-flex justify-content-between align-items-center">
                                                                    <h5 class="card-title mb-0">
                                                                        <i class="mdi mdi-format-list-bulleted mr-2"></i>
                                                                        Recent Supplier Tickets
                                                                    </h5>
                                                                    <div class="btn-group" role="group">
                                                                        <button type="button" class="btn btn-sm btn-outline-warning" onclick="filterByStatus('PENDING')">Pending</button>
                                                                        <button type="button" class="btn btn-sm btn-outline-info" onclick="filterByStatus('IN_PROGRESS')">In Progress</button>
                                                                        <button type="button" class="btn btn-sm btn-outline-success" onclick="filterByStatus('COMPLETED')">Completed</button>
                                                                        <button type="button" class="btn btn-sm btn-outline-secondary" onclick="showAllTickets()">All</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="card-body p-0">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover mb-0" id="supplierTicketsTable">
                                                                        <thead class="thead-light">
                                                                            <tr>
                                                                                <th>Ticket ID</th>
                                                                                <th>Subject</th>
                                                                        ...
                                                                        <tbody id="supplierTicketsTableBody">
                                                                            <!-- Data will be loaded via AJAX -->
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                            ...
                                            @if(auth()->user()->divisi != 8)
                                            <div class="card-body">
                                                <h5>Timeline Kedatangan Supplier</h5>
                                                <div class="supplier-timeline" id="supplierTimelineContainer">
                                                    <div class="text-center p-4">
                                                        <div class="spinner-border text-primary" role="status">
                                                            <span class="sr-only">Loading...</span>
                                                        </div>
                                        ...
                                        <div class="modal-body">
                                            <div id="deliveryDetailContent">
                                                <div class="text-center p-4">
                                                    ...
                                                    <p class="mt-2">Memuat detail delivery...</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="openFullDetail()">
