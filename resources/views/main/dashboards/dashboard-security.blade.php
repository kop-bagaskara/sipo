                ...
                <div class="card">
                    <div class="card-body" id="dashboardTabs">
                        ...
                        @elseif (auth()->user()->divisi != 8)
                            <a href="{{ route('dashboard') }}" class="nav-link btn btn-info mb-2 w-100 text-left"
                            ...
                            <a href="{{ route('dashboard.ppic') }}" class="nav-link btn btn-info mb-2 w-100 text-left"
                            ...
                            <a href="{{ route('dashboard.prepress') }}" class="nav-link btn btn-info mb-2 w-100 text-left"
                            ...
                            {{-- <a href="{{ route('dashboard.development') }}"
                                class="nav-link btn btn-info mb-2 w-100 text-left" id="development-tab" data-bs-toggle="tab"
                        ...
                        @if (auth()->user()->divisi == 8 || auth()->user()->divisi == 1)
                            {{-- <a href="{{ route('dashboard.supplier') }}" class="nav-link btn btn-info mb-2 w-100 text-left"
                        ...
                        @if (auth()->user()->divisi == 1)
                            {{-- <br> --}}
                            <a href="{{ route('dashboard.security') }}" class="nav-link active btn btn-info mb-2 w-100 text-left"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-2">
                                                                            <a href="{{ route('security.vehicle-checklist.create') }}"
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <a href="{{ route('security.goods-movement.create') }}"
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <a href="{{ route('security.daily-activity.create') }}"
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <a href="{{ route('hr.reports.security') }}"
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <a href="{{ route('hr.security-master.index') }}"
