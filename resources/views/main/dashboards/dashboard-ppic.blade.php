            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body" id="dashboardTabs">
                        ...
                        <a href="{{ route('dashboard.security') }}" class="nav-link active btn btn-info w-100 text-left" id="security-tab" data-bs-toggle="tab"
                        ...
                        <a href="{{ route('dashboard') }}" class="nav-link btn btn-info w-100 text-left mb-2" id="overview-tab" data-bs-toggle="tab"
                        ...
                        <a href="{{ route('dashboard') }}" class="nav-link active btn btn-info w-100 text-left mb-2" id="ppic-tab" data-bs-toggle="tab"
                        ...
                        <a href="{{ route('dashboard.prepress') }}" class="nav-link btn btn-info w-100 text-left mb-2" id="prepress-tab" data-bs-toggle="tab"
                        ...
                        {{-- <a href="{{ route('dashboard.development') }}" class="nav-link btn btn-info w-100 text-left mb-2" id="development-tab" data-bs-toggle="tab"
                        ...
                        {{-- <button class="nav-link btn btn-info w-100 text-left mb-2" id="supplier-tab" data-bs-toggle="tab"
                        ...
                        <a href="{{ route('dashboard.security') }}" class="nav-link btn btn-info w-100 text-left mb-2" id="security-tab" data-bs-toggle="tab"
                            data-bs-target="#security" type="button" role="tab" aria-controls="security"
                            aria-selected="true">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="dashboardTabContent">
                            ...
                            <div class="tab-pane fade show active" id="ppic" role="tabpanel" aria-labelledby="ppic-tab">
                                <div class="row">
                                    <div class="col-12">
