            ...
            $(document).ready(function() {
                ...
                function updateMinusPaper() {
                    ...
                    allPaperColumns.forEach(function(paperCol, index) {
                        ...
                        // MINUS PAPER PCS = Total Stok Layer 2 - Total Permintaan
                        const minusPaperPCS = totalStokLayer2 - totalPermintaan;
                ...
                async function renderWorkspace() {
                    ...
                    allPaperColumns.forEach(function(paperCol) {
                        ...
                        // Force set warna kuning dengan inline style untuk memastikan
                        paperTotalCell.style.backgroundColor = '#fff2cc';
                        paperTotalCell.style.setProperty('background-color', '#fff2cc', 'important');
