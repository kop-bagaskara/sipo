...
@section('body')
                    ...
                    <div class="col-12">
                        <table class="table process-table">
                            ...
                            <tbody>
                                ...
                                {{-- <tr>
                                    <td class="text-center">
                                        <input type="radio" name="process_choice" class="check-process" id="proc_emboss"
                                            value="EMBOSS">
                                        <label for="proc_emboss" class="sr-only">Pilih proses EMBOSS</label>
                                    </td>
                                    <td><strong>EMBOSS</strong></td>
                                    <td>Proses relief/tekstur pada permukaan material (efek 3D).</td>
                                </tr> --}}
                                <tr>
                                    <td class="text-center">
                                ...
                                {{-- <tr>
                                    <td class="text-center">
                                        <input type="radio" name="process_choice" class="check-process" id="proc_lem"
                                            value="LEM">
                                        <label for="proc_lem" class="sr-only">Pilih proses LEM</label>
                                    </td>
                                    <td><strong>LEM</strong></td>
                                    <td>Aplikasi lem manual untuk detail presisi tinggi.</td>
                                </tr> --}}
                            </tbody>
                        </table>
                    </div>
    ...
    @section('scripts')
        ...
        <script src="{{ asset('sipo_krisan/public/new/plugins/datatables/buttons.bootstrap4.js') }}"></script>
                ...
                $('#btnContinue').on('click', function() {
                    if (selectedProcesses.length > 0) {
                        ...
                        if (chosenProcess === 'GLUEING') {
                            const planningUrl = "{{ route('planning.glueing') }}";
                            ...
                            const planningUrl = "{{ route('planning.blade') }}";
