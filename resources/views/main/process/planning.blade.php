                    ...
                    <div class="card-body">
                        ...
                        <div id="table-work-order" style="display: block;">
                            <div id="advanced_filter_wo">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label id="filter_label_from">{{ in_array('PLONG', $processList) ? 'PLAN CETAK FINISH PADA - From' : 'SO Date - From' }}</label>
                                        <input type="date" class="form-control" name="from_date_advanced_filter_wo"
                                            id="from_date_advanced_filter_wo">
                                    </div>
                                    <div class="col-md-4">
                                        <label id="filter_label_to">{{ in_array('PLONG', $processList) ? 'PLAN CETAK FINISH PADA - To' : 'SO Date - To' }}</label>
                    ...
                    if (isPlongGlobalTable) {
                        ...
                        for (let groupIndex = 0; groupIndex < itemsToProcess.length; groupIndex++) {
                            ...
                            if (!isPlongGlobalTable) {
                                ...
                                var machineUnit = '';
                                $.ajax({
                                    url: '{{ route('get-machine-capacity') }}',
                                    type: 'POST',
                                    data: {
                                        machine: machine
                                    },
