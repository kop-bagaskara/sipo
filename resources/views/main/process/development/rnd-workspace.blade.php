    ...
    @section('scripts')
        ...
        <script>
            ...
            $(document).ready(function() {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                buttons +=
                                    '<a href="{{ route('development.rnd-workspace.view', ':id') }}'
                                    .replace(':id', row.id) +
                                ...
                                if (canEdit) {
                                    buttons +=
                                        '<a href="{{ route('development.rnd-workspace.edit', ':id') }}'
                                        .replace(':id', row.id) +
                                ...
                                if (row.status_job === 'DRAFT') {
                                    buttons +=
                                        '<a href="{{ route('development.rnd-workspace.send-to-prepress', ':id') }}'
                                        .replace(':id', row.id) +
                ...
                //     var url = '{{ route('development.rnd-workspace.view', ':id') }}'.replace(':id', jobId);
                ...
                function sendJobToPrepress(jobId) {
                    ...
                    $.ajax({
                        url: '{{ route('development.rnd-workspace.send-to-prepress', ':id') }}'.replace(':id',
                            jobId),
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}'
                ...
                function deleteJob(jobId) {
                    ...
                    $.ajax({
                        url: '{{ route('development.rnd-workspace.delete', ':id') }}'.replace(':id', jobId),
                        type: 'DELETE',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
