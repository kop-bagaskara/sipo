    ...
    @section('content')
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">Data Job Development</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">Data Job Development</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="btn btn-info" href="{{ route('development.development-input.form') }}" style="width: 100%;">Input
                            Job Development</a>
                        <br>
                        <br>

                        <div class="">
                            {{-- button Laporan Pribadi & Refresh --}}
                            <div class="mb-2">
                                <button class="btn btn-info" id="btn-laporan-pribadi">Laporan Pribadi</button>
                                <button class="btn btn-secondary ml-2" id="btn-refresh-all">Refresh All</button>
                            </div>
                            <table id="datatable-job-order-development" class="table"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="white-space: nowrap;">Job Development</th>
                                        {{-- <th>Data</th> --}}
                                        <th>Prioritas</th>
    ...
    @section('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                var datatable = $('#datatable-job-order-development').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: "{{ route('development.job-order.data') }}",
                        type: "POST",
                        data: function(d) {
                    ...
                    columns: [
                        ...
                        // },
                        {
                            data: 'nomor_job_development',
                            name: 'nomor_job_development',
                            render: function(data, type, row) {
                                return `<span class="cust-col">${data}</span>`;
                            }
                        },
                        {
                            data: 'tanggal_job_development',
                            name: 'tanggal_job_development',
                            render: function(data, type, row) {
                        ...
                        // },
                        {
                            data: 'job_development',
                            name: 'job_development'
                        },
                        // {
                        //     data: 'file_data',
                        //     name: 'file_data',
                        ...
                        // },
                        {
                            ...
                            render: function(data, type, row) {
                                console.log(data);
                                return data == 'Urgent' ?
                                    '<button type="button" class="btn btn-danger btn-sm" data-jobdevelopmentno="${row.id}" data-status="Urgent">Urgent</button>' :
                                    '<button type="button" class="btn btn-success btn-sm w-100" data-jobdevelopmentno="${row.id}" data-status="Normal">Normal</button>';
                            }
                        },
                        {
                            data: 'status_job',
                ...
                // Laporan Pribadi: filter by created_by = current user
                $('#btn-laporan-pribadi').on('click', function () {
                    window.__laporanPribadi = true;
                    datatable.ajax.reload(null, true);
                });

                // Refresh All: hapus filter
