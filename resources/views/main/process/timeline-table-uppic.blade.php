                    ...
                    if (result.success && result.data) {
                        ...
                        machineData.forEach(item => {
                            ...
                            if (jobOrderData && jobOrderData.doc_no) {
                                ...
                                // Update STATUS column (index 14, after AKHIR CETAK)
                    ...
                    if (result.success && result.data) {
                        ...
                        machineData.forEach(item => {
                            ...
                            if (!ukuranKertasCell) {
                                ...
                                const row = tbody.querySelector(`tr[data-item-id="${item.id}"]`);
                                if (row && row.cells[15]) {
                                    const fallbackCell = row.cells[15]; // Index 15 = UKURAN KERTAS
            ...
            updateMachineTableDisplay(machineCode, items) {
                ...
                items.forEach((item, index) => {
                    ...
                    if (row) {
                        ...
                        // Update ukuran kertas column (index 15, after STATUS)
