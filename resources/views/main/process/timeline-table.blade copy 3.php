    ...
    <script>
        ...
        function recalculateMachineTimeline(changedInput) {
            ...
            rows.forEach((row, index) => {
                ...
                const startTimeCell = row.querySelector('td:nth-child(12)'); // MULAI CETAK
                const endTimeCell = row.querySelector('td:nth-child(13)'); // AKHIR CETAK
            ...
            items.forEach((item, index) => {
                ...
                // Update tampilan
                item.startTimeCell.textContent = Utils.formatDateTime(startTime.toISOString());
            ...
            console.log('✅ Timeline recalculated for machine:', machineCode);
        }
