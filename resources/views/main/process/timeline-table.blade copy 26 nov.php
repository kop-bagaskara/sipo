...
@section('scripts')
    ...
    <script>
                ...
                try {
                    ...
                    if (result.success && result.data) {
                        ...
                        machineData.forEach(item => {
                            ...
                            // Ukuran Kertas column is at index 16 (after STATUS)
                            const ukuranKertasCell = row.cells[15];
                            if (!ukuranKertasCell) return;
                            ...
                            if (paperSizeData) {
                                ...
                                ukuranKertasCell.innerHTML = displayText;
                                ukuranKertasCell.setAttribute('title', `Bahan: ${paperSizeData.bahan1 || 'N/A'}, UC: ${paperSizeData.ukuran_cetak || 'N/A'}`);
        ...
        `;
             ...
             */
            showSendJobOrderModal(machineCode) {
                ...
                if (machineItems.length === 0) {
                    ...
                    machineItems.forEach((item, index) => {
                        ...
                        row.innerHTML = `
                            ...
                            <td><span class="badge badge-success">${jobOrder}</span></td>
            ...
            async sendJobOrderToDatabase(machineCode) {
                try {
                    ...
                    if (machineItems.length === 0) {
                        Utils.showToast('❌ Tidak ada Job Order untuk hari ini yang akan dikirim', 'warning');
                        return;
                    }
