                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="tanggal" class="form-control" required
                                        value="{{ $jobOrder->tanggal_job_order ? date('Y-m-d', strtotime($jobOrder->tanggal_job_order)) : '' }}">
                                    <div class="error-message"></div>
                                </div>
                                <div class="col-md-6">
                                    <label for="job_deadline">Job Deadline</label>
                                    <input type="date" name="job_deadline" class="form-control" required
                                        value="{{ $jobOrder->tanggal_deadline ? date('Y-m-d', strtotime($jobOrder->tanggal_deadline)) : '' }}">
                                    <div class="error-message"></div>
                                </div>
                            </div>
                            <hr>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered mb-2">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:40%">
                                                                <input type="text" name="color[{{ $i }}]"
                                                                    id="color{{ $i }}" class="form-control"
                                                                    value="{{ isset($colorDetails[$i - 1]) ? $colorDetails[$i - 1] : '' }}">
                                                            </td>
                                                            <td style="width:10%">{{ $i + 5 }}. </td>
                                                            <td style="width:40%">
                                                                <input type="text" name="color[{{ $i + 5 }}]"
                                                                    id="color{{ $i + 5 }}" class="form-control"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="qty_order_estimation" class="form-control"
                                                    required value="{{ $jobOrder->qty_order_estimation }}">
                                                <div class="error-message"></div>
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <select name="job_order[]" id="job_order" class="form-control select2" multiple>
                                                    @foreach ($jenisPekerjaan ?? [] as $item)
                                                        <option value="{{ $item->nama_jenis }}"
                                                            {{ in_array($item->nama_jenis, is_array($jobOrder->job_order) ? $jobOrder->job_order : [$jobOrder->job_order]) ? 'selected' : '' }}>
                                                            {{ $item->nama_jenis }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                    ...
                                                    <tr>
                                                        <td style="width:10%">
                                                            <input type="checkbox" name="file_data[]" id="file_data_contoh_cetak"
                                                                value="Contoh Cetak"
                                                                {{ in_array('Contoh Cetak', $fileDataList ?? []) ? 'checked' : '' }}>
                                                        ...
                                                        <td style="width:10%">
                                                            <input type="checkbox" name="file_data[]" id="file_data_contoh_produk"
                                                                value="Contoh Produk"
                                                                {{ in_array('Contoh Produk', $fileDataList ?? []) ? 'checked' : '' }}>
                                                    ...
                                                    <tr>
                                                        <td style="width:10%">
                                                            <input type="checkbox" name="file_data[]" id="file_data_softcopy"
                                                                value="File Softcopy"
                                                                {{ in_array('File Softcopy', $fileDataList ?? []) ? 'checked' : '' }}>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="prioritas_job" id="prioritas_job" class="form-control"
                                                    ...
                                                    <option value="Urgent"
                                                        {{ $jobOrder->prioritas_job == 'Urgent' ? 'selected' : '' }}>Urgent
                                                    </option>
                                                    <option value="Normal"
                                                        {{ $jobOrder->prioritas_job == 'Normal' ? 'selected' : '' }}>Normal
                                                    </option>
                                                </select>
                                                <div class="error-message"></div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea name="catatan" id="catatan" class="form-control">{{ $jobOrder->catatan }}</textarea>
                                                <div class="error-message"></div>
                                            </td>
                                        </tr>
                                        <tr>
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between mb-2 p-2 border rounded">
                                                                ...
                                                                <div class="d-flex">
                                                                    ...
                                                                    @if (Auth::user()->jabatan == '3' || Auth::user()->jabatan == '4' || $jobOrder->created_by == Auth::user()->name)
                                                                        <form action="{{ route('prepress.job-order.delete-attachment', $attachment->id) }}" method="POST" class="d-inline">
                                                                            @csrf
                                                                            @method('POST')
                                                                            <button type="submit"
                                    ...
                                    <div class="row">
                                        <div class="col" style="text-align: center;">
                                            ...
                                            <br>
                                            <span>{{ $jobOrder->created_at ? date('Y-m-d', strtotime($jobOrder->created_at)) : date('Y-m-d') }}</span>
                                        </div>
                                        <div class="col" style="text-align: center;">
                                            ...
                                            <br>
                                            <span>{{ $jobOrder->received_at ? date('Y-m-d', strtotime($jobOrder->received_at)) : '-' }}</span>
                                        </div>
                                    </div>
                                </div>
            ...
            $(document).ready(function() {
                ...
                $('#submit-button-delete').click(function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{ route('prepress.job-order.delete-plan', $jobOrder->id) }}",
                                type: "POST",
                                data: {
                                    _token: "{{ csrf_token() }}"
                                },
