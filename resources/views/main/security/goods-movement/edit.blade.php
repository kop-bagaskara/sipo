...
@section('title')
    @if (isset($mode) && $mode === 'update-jam-keluar')
        Update Jam Keluar
    @else
...
@section('body')
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('security.goods-movement.index') }}">Keluar/Masuk
                            Barang</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">
                            @if (isset($mode) && $mode === 'update-jam-keluar')
                                Update Jam Keluar - No. Urut: {{ $movement->no_urut }}
                            @else
                                Edit Keluar/Masuk Barang
                            @endif
                        </h4>
                    ...
                    <div class="card-body">
                        <form action="{{ route('security.goods-movement.update', $movement->id) }}" method="POST"
                            id="movementForm">
                            @csrf
                            @method('PUT')
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p class="mb-1"><strong>Tanggal:</strong>
                                                        {{ $movement->tanggal_formatted }}</p>
                                                    <p class="mb-1"><strong>Nama:</strong>
                                                        {{ $movement->nama_pengunjung }}</p>
                                                    <p class="mb-1"><strong>Perusahaan:</strong>
                                                        {{ $movement->perusahaan_asal }}</p>
                                                </div>
                                                <div class="col-md-6">
                                                    <p class="mb-1"><strong>Jam Masuk:</strong>
                                                        {{ $movement->jam_masuk }}</p>
                                                    <p class="mb-1"><strong>No. Polisi:</strong>
                                                        {{ $movement->no_polisi }}</p>
                                                    <p class="mb-1"><strong>Driver:</strong> {{ $movement->nama_driver }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        <div class="alert alert-info">
                                            ...
                                            <p class="mb-0">
                                                No. Urut: <strong>{{ $movement->no_urut }}</strong> |
                                                Petugas: <strong>{{ $movement->petugas_security }}</strong>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select form-control" name="lokasi" required>
                                        ...
                                        <option value="1"
                                            {{ old('lokasi', $movement->lokasi) == '1' ? 'selected' : '' }}>Lokasi 19
                                            (KRISANTHIUM)</option>
                                        <option value="2"
                                            {{ old('lokasi', $movement->lokasi) == '2' ? 'selected' : '' }}>Lokasi 23
                                            (KRISANTHIUM)</option>
                                        <option value="3"
                                            {{ old('lokasi', $movement->lokasi) == '3' ? 'selected' : '' }}>Lokasi 15
                                            (BERBEK)</option>
                                    </select>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="date"
                                                    ...
                                                    name="tanggal"
                                                    value="{{ old('tanggal', $movement->tanggal->format('Y-m-d')) }}"
                                                    required>
                                                @error('tanggal')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="time"
                                                    ...
                                                    value="{{ old('jam_masuk', $movement->jam_masuk ? \Carbon\Carbon::parse($movement->jam_masuk)->format('H:i') : '') }}"
                                                    required>
                                                @error('jam_masuk')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="time"
                                                    ...
                                                    value="{{ old('jam_keluar', $movement->jam_keluar ? \Carbon\Carbon::parse($movement->jam_keluar)->format('H:i') : '') }}">
                                                @error('jam_keluar')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            {{-- <div class="mb-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="auto_fill_jam_masuk">
                                                    <label class="form-check-label" for="auto_fill_jam_masuk">
                                                        <small class="text-muted">Centang jika hanya update jam keluar (jam masuk akan sama dengan jam keluar)</small>
                                                    </label>
                                                </div>
                                            </div> --}}
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select
                                                    ...
                                                    <option value="IN"
                                                        {{ old('status_laporan', $movement->status_laporan) == 'IN' ? 'selected' : '' }}>
                                                        IN (Baru Masuk)</option>
                                                    <option value="OUT"
                                                        {{ old('status_laporan', $movement->status_laporan) == 'OUT' ? 'selected' : '' }}>
                                            ...
                                            {{-- <div class="mb-3">
                                                ...
                                                <select
                                                    ...
                                                    <option value="pagi"
                                                        {{ old('shift', $movement->shift) == 'pagi' ? 'selected' : '' }}>
                                                        Pagi </option>
                                                    <option value="siang"
                                                        {{ old('shift', $movement->shift) == 'siang' ? 'selected' : '' }}>
                                                        Siang </option>
                                                    <option value="malam"
                                                        {{ old('shift', $movement->shift) == 'malam' ? 'selected' : '' }}>
                                                        Malam </option>
                                                </select>
                                                @error('shift')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">Jenis Masuk/Keluar <span
                                                        class="text-danger">*</span></label>
                                                <select
                                                    class="form-select form-control @error('jenis_movement') is-invalid @enderror"
                                                    name="jenis_movement" id="jenis_movement" required>
                                                    <option value="">Pilih Jenis</option>
                                                    <option value="masuk"
                                                        {{ old('jenis_movement', $movement->jenis_movement) == 'masuk' ? 'selected' : '' }}>
                                                        Barang Masuk</option>
                                                    <option value="keluar"
                                                        {{ old('jenis_movement', $movement->jenis_movement) == 'keluar' ? 'selected' : '' }}>
                                                        Barang Keluar</option>
                                                </select>
                                                @error('jenis_movement')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div> --}}
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('nama_pengunjung', $movement->nama_pengunjung) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('perusahaan_asal') is-invalid @enderror"
                                                    name="perusahaan_asal"
                                                    value="{{ old('perusahaan_asal', $movement->perusahaan_asal) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="no_telepon"
                                                    value="{{ old('no_telepon', $movement->no_telepon) }}"
                                                    ...
                                                    @foreach ($movement->barang_items as $index => $item)
                                                        <div class="barang-item mb-3" data-index="{{ $index }}">
                                                            <div
                                                                ...
                                                                <h6 class="mb-0">Barang #{{ $index + 1 }}</h6>
                                                                <button type="button" class="btn btn-sm btn-danger"
                                                                    onclick="removeBarangItem({{ $index }})"
                                                                    style="{{ count($movement->barang_items) <= 1 ? 'display: none;' : '' }}">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Jenis Barang <span
                                                                                class="text-danger">*</span></label>
                                                                        <input type="text"
                                                                            class="form-control @error('barang.' . $index . '.jenis_barang') is-invalid @enderror"
                                                                            name="barang[{{ $index }}][jenis_barang]"
                                                                            value="{{ old('barang.' . $index . '.jenis_barang', $item['jenis_barang'] ?? '') }}"
                                                                            placeholder="Contoh: Kertas, Tinta, Mesin, dll"
                                                                            required>
                                                                        @error('barang.' . $index . '.jenis_barang')
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Jumlah <span
                                                                                class="text-danger">*</span></label>
                                                                        <input type="number"
                                                                            class="form-control @error('barang.' . $index . '.jumlah') is-invalid @enderror"
                                                                            name="barang[{{ $index }}][jumlah]"
                                                                            value="{{ old('barang.' . $index . '.jumlah', $item['jumlah'] ?? '') }}"
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Satuan <span
                                                                                class="text-danger">*</span></label>
                                                                        <input type="text"
                                                                            class="form-control @error('barang.' . $index . '.satuan') is-invalid @enderror"
                                                                            name="barang[{{ $index }}][satuan]"
                                                                            value="{{ old('barang.' . $index . '.satuan', $item['satuan'] ?? '') }}"
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="number" step="0.01"
                                                                            class="form-control @error('barang.' . $index . '.berat') is-invalid @enderror"
                                                                            name="barang[{{ $index }}][berat]"
                                                                            value="{{ old('barang.' . $index . '.berat', $item['berat'] ?? '') }}"
                                                                            placeholder="Berat" min="0">
                                                                        @error('barang.' . $index . '.berat')
                                                                            <div class="invalid-feedback">{{ $message }}
                                                                            </div>
                                                                        @enderror
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="d-flex gap-1">
                                                                            <button type="button"
                                                                                ...
                                                                                onclick="duplicateBarangItem({{ $index }})"
                                                                                title="Duplikat">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control @error('barang.' . $index . '.deskripsi_barang') is-invalid @enderror"
                                                                    name="barang[{{ $index }}][deskripsi_barang]" rows="2" placeholder="Deskripsi detail barang">{{ old('barang.' . $index . '.deskripsi_barang', $item['deskripsi_barang'] ?? '') }}</textarea>
                                                                @error('barang.' . $index . '.deskripsi_barang')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="barang-item mb-3" data-index="0">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('barang.0.jenis_barang', $movement->jenis_barang) }}"
                                                                        placeholder="Contoh: Kertas, Tinta, Mesin, dll"
                                                                        required>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number"
                                                                        ...
                                                                        value="{{ old('barang.0.jumlah', $movement->jumlah) }}"
                                                                        placeholder="Jumlah" min="0" required>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ old('barang.0.satuan', $movement->satuan) }}"
                                                                        placeholder="pcs, kg, box" required>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" step="0.01"
                                                                        ...
                                                                        name="barang[0][berat]"
                                                                        value="{{ old('barang.0.berat', $movement->berat) }}"
                                                                        placeholder="Berat" min="0">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control @error('barang.0.deskripsi_barang') is-invalid @enderror"
                                                                name="barang[0][deskripsi_barang]" rows="2" placeholder="Deskripsi detail barang">{{ old('barang.0.deskripsi_barang', $movement->deskripsi_barang) }}</textarea>
                                    ...
                                    <div class="card border optional-field">
                                        ...
                                        <div class="card-body">
                                            <div id="barang-keluar-items-container">
                                                @if ($movement->barang_keluar_items && count($movement->barang_keluar_items) > 0)
                                                    <!-- Display existing barang keluar items -->
                                                    @foreach ($movement->barang_keluar_items as $index => $item)
                                                        <div class="barang-item mb-3" data-index="{{ $index }}">
                                                            <div
                                                                class="d-flex justify-content-between align-items-center mb-2">
                                                                <h6 class="mb-0">Barang Keluar #{{ $index + 1 }}</h6>
                                                                <button type="button" class="btn btn-sm btn-danger"
                                                                    onclick="removeBarangKeluarItem({{ $index }})"
                                                                    style="{{ count($movement->barang_keluar_items) <= 1 ? 'display: none;' : '' }}">
                                                                    <i class="mdi mdi-delete"></i> Hapus
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text"
                                                                            class="form-control @error('barang_keluar.' . $index . '.jenis_barang') is-invalid @enderror"
                                                                            name="barang_keluar[{{ $index }}][jenis_barang]"
                                                                            value="{{ old('barang_keluar.' . $index . '.jenis_barang', $item['jenis_barang'] ?? '') }}"
                                                                            placeholder="Contoh: Kertas, Tinta, Mesin, dll">
                                                                        @error('barang_keluar.' . $index . '.jenis_barang')
                                                                            <div class="invalid-feedback">{{ $message }}
                                                                            </div>
                                                                        @enderror
                                                                    </div>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="number"
                                                                            class="form-control @error('barang_keluar.' . $index . '.jumlah') is-invalid @enderror"
                                                                            name="barang_keluar[{{ $index }}][jumlah]"
                                                                            value="{{ old('barang_keluar.' . $index . '.jumlah', $item['jumlah'] ?? '') }}"
                                                                            placeholder="Jumlah" min="0">
                                                                        @error('barang_keluar.' . $index . '.jumlah')
                                                                            <div class="invalid-feedback">{{ $message }}
                                                                            </div>
                                                                        @enderror
                                                                    </div>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text"
                                                                            class="form-control @error('barang_keluar.' . $index . '.satuan') is-invalid @enderror"
                                                                            name="barang_keluar[{{ $index }}][satuan]"
                                                                            value="{{ old('barang_keluar.' . $index . '.satuan', $item['satuan'] ?? '') }}"
                                                                            placeholder="pcs, kg, box">
                                                                        @error('barang_keluar.' . $index . '.satuan')
                                                                            <div class="invalid-feedback">{{ $message }}
                                                                            </div>
                                                                        @enderror
                                                                    </div>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Berat (kg)</label>
                                                                        <input type="number" step="0.01"
                                                                            class="form-control @error('barang_keluar.' . $index . '.berat') is-invalid @enderror"
                                                                            name="barang_keluar[{{ $index }}][berat]"
                                                                            value="{{ old('barang_keluar.' . $index . '.berat', $item['berat'] ?? '') }}"
                                                                            placeholder="Berat" min="0">
                                                                        @error('barang_keluar.' . $index . '.berat')
                                                                            <div class="invalid-feedback">{{ $message }}
                                                                            </div>
                                                                        @enderror
                                                                    </div>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="d-flex gap-1">
                                                                            <button type="button"
                                                                                class="btn btn-sm btn-outline-primary"
                                                                                onclick="duplicateBarangKeluarItem({{ $index }})"
                                                                                title="Duplikat">
                                                                                <i class="mdi mdi-content-duplicate"></i>
                                                                            </button>
                                                                        </div>
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="form-label">Deskripsi Barang</label>
                                                                <textarea class="form-control @error('barang_keluar.' . $index . '.deskripsi_barang') is-invalid @enderror"
                                                                    name="barang_keluar[{{ $index }}][deskripsi_barang]" rows="2"
                                                                    placeholder="Deskripsi detail barang">{{ old('barang_keluar.' . $index . '.deskripsi_barang', $item['deskripsi_barang'] ?? '') }}</textarea>
                                                                @error('barang_keluar.' . $index . '.deskripsi_barang')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
                                                        </div>
                            ...
                            <div class="row">
                                {{-- <div class="col-md-4">
                                    <div class="card border optional-field">
                                        ...
                                        <div class="card-body">
                                            <div id="asal_field" class="mb-3">
                                                <label class="form-label">Asal Barang</label>
                                                <textarea class="form-control @error('asal') is-invalid @enderror" name="asal" rows="3"
                                                    placeholder="Dari mana barang berasal">{{ old('asal', $movement->asal) }}</textarea>
                                                @error('asal')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>

                                            <div id="tujuan_field" class="mb-3">
                                                ...
                                                <textarea class="form-control @error('tujuan') is-invalid @enderror" name="tujuan" rows="3"
                                                    placeholder="Kemana barang akan dibawa">{{ old('tujuan', $movement->tujuan) }}</textarea>
                                                @error('tujuan')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" rows="2"
                                                    placeholder="Alamat lengkap">{{ old('alamat', $movement->alamat) }}</textarea>
                                                @error('alamat')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('jenis_kendaraan', $movement->jenis_kendaraan) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="no_polisi" value="{{ old('no_polisi', $movement->no_polisi) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nama_driver" value="{{ old('nama_driver', $movement->nama_driver) }}"
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="no_surat_jalan"
                                                    value="{{ old('no_surat_jalan', $movement->no_surat_jalan) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="no_invoice"
                                                    value="{{ old('no_invoice', $movement->no_invoice) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('dokumen_pendukung') is-invalid @enderror" name="dokumen_pendukung"
                                                    rows="2" placeholder="Dokumen lain yang menyertai">{{ old('dokumen_pendukung', $movement->dokumen_pendukung) }}</textarea>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" rows="2"
                                                    placeholder="Keterangan tambahan">{{ old('keterangan', $movement->keterangan) }}</textarea>
                                                @error('keterangan')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('catatan_security') is-invalid @enderror" name="catatan_security"
                                                    rows="2" placeholder="Catatan dari security">{{ old('catatan_security', $movement->catatan_security) }}</textarea>
                                                @error('catatan_security')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
    ...
    @section('script')
        ...
        <script type="text/javascript">
            ...
            let barangItemIndex = {{ $movement->barang_items ? count($movement->barang_items) - 1 : 0 }};
            ...
            let barangKeluarItemIndex = {{ $movement->barang_keluar_items ? count($movement->barang_keluar_items) - 1 : 0 }};
