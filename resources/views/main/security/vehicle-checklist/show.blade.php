...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="d-flex justify-content-between">
                <div>
                    <a href="{{ route('security.vehicle-checklist.index') }}" class="btn btn-secondary">
                        <i class="bx bx-arrow-back"></i> Kembali
                    </a>
                    <a href="{{ route('security.vehicle-checklist.edit', $checklist->id) }}" class="btn btn-warning">
                        <i class="bx bx-edit"></i> Edit
                    </a>
                        @if ($checklist->status == 'keluar')
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-info text-white border-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="card-title mb-0 text-white">Checklist Kendaraan #{{ $checklist->no_urut }}</h4>
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="avatar-lg mx-auto mb-3">
                                    ...
                                    <h5 class="mb-1 fw-bold">Nama Driver: {{ $checklist->nama_driver }}</h5>
                                    <p class="text-muted mb-2">Model Kendaraan: {{ $checklist->model_kendaraan }}</p>
                                    @if ($checklist->no_polisi)
                                        <span class="badge bg-info text-white fs-6 px-3 py-2">No. Polisi:
                                            {{ $checklist->no_polisi }}</span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 fw-bold">Tanggal: {{ $checklist->tanggal }}</p>
                            </div>
                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-0">
                                                    <span
                                                        class="badge bg-{{ $checklist->shift == 'pagi' ? 'warning' : ($checklist->shift == 'siang' ? 'info' : 'dark') }} fs-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 fw-bold">{{ $checklist->petugas_security }}</p>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                        <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                            <div class="avatar-sm me-3">
                                                <div
                                                    class="avatar-title bg-{{ $checklist->status == 'selesai' ? 'success' : 'warning' }} bg-opacity-10 text-{{ $checklist->status == 'selesai' ? 'success' : 'warning' }} rounded">
                                                    <i
                                                        class="bx bx-{{ $checklist->status == 'selesai' ? 'check-circle' : 'clock' }}"></i>
                                                </div>
                                            </div>
                                            <div>
                                        ...
                                        <p class="mb-0">
                                                    <span
                                                        class="badge bg-{{ $checklist->status == 'selesai' ? 'success' : 'warning' }} fs-6">
    ...
    <div class="row">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-4">
                            <div class="col-md-4">
                                <div class="text-center p-4 bg-default bg-opacity-10 rounded-3">
                                    <h3 class="mb-1 fw-bold">
                                        {{ $checklist->jam_out ? \Carbon\Carbon::parse($checklist->jam_out)->format('H:i') : '-' }}
                                    </h3>
                            ...
                            <div class="col-md-4">
                                <div class="text-center p-4 bg-default bg-opacity-10 rounded-3">
                                    <h3 class="mb-1 fw-bold">
                                        {{ $checklist->km_awal ? number_format($checklist->km_awal) : '-' }}
                                    </h3>
                            ...
                            <div class="col-md-4">
                                <div class="text-center p-4 bg-default bg-opacity-10 rounded-3">
                                    <h3 class="mb-1 fw-bold">
                                        {{ $checklist->bbm_awal ? number_format($checklist->bbm_awal, 2) : '-' }}
                                    </h3>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <p class="mb-0 fw-medium">{{ $checklist->tujuan ?: 'Tidak ada tujuan yang dicatat' }}</p>
                                <small class="text-muted">Lokasi:
                                    @switch($checklist->lokasi)
                ...
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <p class="mb-0 fw-medium">{{ $checklist->keterangan ?: 'Tidak ada keterangan tambahan' }}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Foto Dokumentasi -->
        @if ($checklist->foto_kondisi || $checklist->foto_dashboard || $checklist->foto_driver || $checklist->foto_lainnya)
                        <div class="row">
                <div class="col-12">
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-gradient-success text-white border-0">
                        ...
                        <div class="card-body p-4">
                            <div class="row g-4">
                                @if ($checklist->foto_kondisi)
                                    <div class="col-lg-3 col-md-6">
                                        <div class="card border-0 shadow-sm h-100">
                                            <div class="position-relative">
                                                <img src="{{ url('sipo_krisan/public/storage') }}/{{ $checklist->foto_kondisi }}"
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <button class="btn btn-info btn-sm w-100"
                                                    onclick="viewImage('{{ url('sipo_krisan/public/storage') }}/{{ $checklist->foto_kondisi }}', 'Foto Kondisi Kendaraan')">
                                ...
                                @if ($checklist->foto_dashboard)
                                    <div class="col-lg-3 col-md-6">
                                        <div class="card border-0 shadow-sm h-100">
                                            <div class="position-relative">
                                                <img src="{{ url('sipo_krisan/public/storage') }}/{{ $checklist->foto_dashboard }}"
                                                    class="card-img-top" style="height: 200px; object-fit: cover;"
                                                    alt="Foto Dashboard">
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <button class="btn btn-info btn-sm w-100"
                                                    onclick="viewImage('{{ url('sipo_krisan/public/storage') }}/{{ $checklist->foto_dashboard }}', 'Foto Dashboard/SPIDO')">
                                                    <i class="bx bx-zoom-in me-1"></i> Lihat Detail
                                                </button>
                                            </div>
                                    </div>
                            ...
                            @endif
                                ...
                                @if ($checklist->foto_driver)
                                    <div class="col-lg-3 col-md-6">
                                        <div class="card border-0 shadow-sm h-100">
                                            <div class="position-relative">
                                                <img src="{{ url('sipo_krisan/public/storage') }}/{{ $checklist->foto_driver }}"
                                                    class="card-img-top" style="height: 200px; object-fit: cover;"
                                                    alt="Foto Driver">
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <button class="btn btn-info btn-sm w-100"
                                                    onclick="viewImage('{{ url('sipo_krisan/public/storage') }}/{{ $checklist->foto_driver }}', 'Foto Driver & Kendaraan')">
                                                    <i class="bx bx-zoom-in me-1"></i> Lihat Detail
                                                </button>
                                            </div>
                                        </div>
                                ...
                                @if ($checklist->foto_lainnya)
                                    <div class="col-lg-3 col-md-6">
                                        <div class="card border-0 shadow-sm h-100">
                                            <div class="position-relative">
                                                <img src="{{ url('sipo_krisan/public/storage') }}/{{ $checklist->foto_lainnya }}"
                                                    class="card-img-top" style="height: 200px; object-fit: cover;"
                                                    alt="Foto Lainnya">
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <button class="btn btn-info btn-sm w-100"
                                                    onclick="viewImage('{{ url('sipo_krisan/public/storage') }}/{{ $checklist->foto_lainnya }}', 'Foto Lainnya')">
                                                    <i class="bx bx-zoom-in me-1"></i> Lihat Detail
                                                </button>
                                    </div>
                                </div>
...
<div class="modal fade" id="returnModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('security.vehicle-checklist.return', $checklist->id) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="km_akhir"
                                                min="{{ $checklist->km_awal }}"
                                                placeholder="Min: {{ number_format($checklist->km_awal) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
