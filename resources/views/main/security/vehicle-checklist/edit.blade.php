        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-header">
                    ...
                    <div class="card-body">
                        <form action="{{ route('security.vehicle-checklist.update', $checklist->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-info">
                                        ...
                                        <p class="mb-0">
                                            No. Urut: <strong>{{ $checklist->no_urut }}</strong> |
                                            Status: <strong
                                                class="text-{{ $checklist->status == 'selesai' ? 'success' : 'warning' }}">{{ ucfirst($checklist->status) }}</strong>
                                            |
                                            Petugas: <strong>{{ $checklist->petugas_security }}</strong>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select form-control" name="lokasi" required>
                                        ...
                                        <option value="1" {{ old('lokasi', $checklist->lokasi) == '1' ? 'selected' : '' }}>Lokasi 19 (KRISANTHIUM)</option>
                                        <option value="2" {{ old('lokasi', $checklist->lokasi) == '2' ? 'selected' : '' }}>Lokasi 23 (KRISANTHIUM)</option>
                                        <option value="3" {{ old('lokasi', $checklist->lokasi) == '3' ? 'selected' : '' }}>Lokasi 15 (BERBEK)</option>
                                    </select>
                                    @error('lokasi')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select form-control" name="checklist_pada" required>
                                        ...
                                        <option value="1" {{ old('checklist_pada', $checklist->checklist_pada) == '1' ? 'selected' : '' }}>MASUK</option>
                                        <option value="2" {{ old('checklist_pada', $checklist->checklist_pada) == '2' ? 'selected' : '' }}>KELUAR</option>
                                    </select>
                                    @error('checklist_pada')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                                       name="tanggal" value="{{ old('tanggal', $checklist->tanggal->format('Y-m-d')) }}" required>
                                                @error('tanggal')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="time" class="form-control @error('jam_out') is-invalid @enderror"
                                                       name="jam_out" id="jamInput" value="{{ old('jam_out', $checklist->jam_out ? \Carbon\Carbon::parse($checklist->jam_out)->format('H:i') : '') }}" required>
                                                @error('jam_out')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('nama_driver') is-invalid @enderror"
                                                       name="nama_driver" value="{{ old('nama_driver', $checklist->nama_driver) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('model_kendaraan') is-invalid @enderror"
                                                       name="model_kendaraan" value="{{ old('model_kendaraan', $checklist->model_kendaraan) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('no_polisi') is-invalid @enderror"
                                                       name="no_polisi" value="{{ old('no_polisi', $checklist->no_polisi) }}"
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('km_awal') is-invalid @enderror"
                                                   name="km_awal" id="kmInput" value="{{ old('km_awal', $checklist->km_awal) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('bbm_awal') is-invalid @enderror"
                                                   name="bbm_awal" id="bbmInput" value="{{ old('bbm_awal', $checklist->bbm_awal) }}"
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('tujuan') is-invalid @enderror"
                                                      name="tujuan" rows="3" placeholder="Masukkan tujuan perjalanan" required>{{ old('tujuan', $checklist->tujuan) }}</textarea>
                                            @error('tujuan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('keterangan') is-invalid @enderror"
                                                      name="keterangan" rows="3" placeholder="Keterangan tambahan (opsional)">{{ old('keterangan', $checklist->keterangan) }}</textarea>
                                            @error('keterangan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
