        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    ...
                    {{-- <ul aria-expanded="false" class="collapse">
                        <li><a href="{{ route('dashboard') }}">Overview Data</a>
                </li>
            ...
            <li class="active">
                <a class="waves-effect waves-dark" href="{{ route('hr.requests.index') }}"
                    aria-expanded="false">
                    <i class="mdi mdi-file-document"></i><span class="hide-menu">Form Pengajuan
                        Karyawan</span>
                </a>
            ...
            {{-- PKB --}}
            <li>
                <a class="waves-effect waves-dark" href="{{ route('ebook-pkb.index') }}"
                    aria-expanded="false">
                ...
                <ul aria-expanded="false" class="collapse">
                    <li>
                        ...
                        <ul aria-expanded="false" class="collapse">
                            ...
                            {{-- <li><a href="{{ route('process.plan-first-table') }}">Table View</a>
                    </li> --}}
                    {{-- <li><a href="{{ route('process.plan-first-table-plong') }}">Table View PLONG</a>
            </li> --}}
            ...
            <li>
                ...
                <ul aria-expanded="false" class="collapse">
                    <li>
                        <a href="{{ route('label-management.index') }}" aria-expanded="false">
                            Label
                            Management</a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('forecasting.index') }}" aria-expanded="false">
                            Forecasting</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false" class="collapse">
                            ...
                            {{-- <li><a href="{{ route('hr.requests.index') }}">Form Pengajuan Karyawan</a>
                    </li> --}}
                    @if (Auth::user()->divisi == '1' || (Auth::user()->divisi == '7' && Auth::user()->jabatan != '7'))
                    <li><a href="{{ route('hr.approval-settings.index') }}">Master Setting
                            Approval</a></li>
                    <li><a href="{{ route('hr.approval-settings.divisions.index') }}">Setting
                            Approval Per Divisi</a></li>
                    <li><a href="{{ route('hr.absence-settings.index') }}">Master Setting
                            Absence</a></li>
                    @endif
                    {{-- <li><a href="{{ route('hr.requests.create') }}">Buat Pengajuan Baru</a>
            </li> --}}
            ...
            <li>
                <a class="has-arrow waves-effect waves-dark" href="#"
                    aria-expanded="false">
                    <span class="hide-menu">Portal
                        Training</span>
                </a>
                <ul aria-expanded="false" class="collapse">
                    <li>
                        <a href="{{ route('hr.portal-training.master.dashboard.index') }}"
                            aria-expanded="false">
                            <i class="mdi mdi-view-dashboard mr-2"></i>Dashboard
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('hr.portal-training.index') }}" aria-expanded="false">
                            <i class="mdi mdi-play-circle mr-2"></i>Training Saya
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('hr.portal-training.scores.index') }}"
                            aria-expanded="false">
                            <i class="mdi mdi-chart-line mr-2"></i>Nilai Training
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul aria-expanded="false" class="collapse">
                    ...
                    <li><a href="{{ route('master.menu-navigation-settings.index') }}">Menu Navigation Settings</a></li>
