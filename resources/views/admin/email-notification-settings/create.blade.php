...
@section('title', 'Tambah Setting Email')
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        ...
                        Tambah Setting Email Notification
                    </h4>
                ...
                <div class="card-body">
                    <form action="{{ route('email-notification-settings.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Deskripsi singkat tentang notifikasi ini">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
