                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <a href="{{ route('public.staff-applicant.create') }}" class="btn btn-success btn-lg btn-block">
                                <i class="mdi mdi-plus-circle mr-2"></i>
                                Tambah Data Pelamar Baru
                            </a>
                        </div>
                        <div class="col-md-4 mb-3">
                            <a href="{{ route('public.staff-applicant.index') }}" class="btn btn-primary btn-lg btn-block">
                                <i class="mdi mdi-format-list-bulleted mr-2"></i>
                                Lihat Daftar Pelamar
                            </a>
                        </div>
                        <div class="col-md-4 mb-3">
                            <a href="{{ route('public.staff-applicant.index', ['status' => 'test']) }}" class="btn btn-warning btn-lg btn-block">
                                ...
                                <tbody>
                                    @foreach($recentApplicants as $applicant)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('public.staff-applicant.show', $applicant) }}" class="btn btn-info btn-sm">
