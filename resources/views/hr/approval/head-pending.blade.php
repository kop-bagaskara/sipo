...
@section('content')
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card"><div class="card-body text-center"><h3 class="text-warning">{{ $totalPending }}</h3><p class="text-muted mb-0">Total Menunggu</p></div></div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="card"><div class="card-body text-center"><h3 class="text-warning">{{ $dataLemburCount }}</h3><p class="text-muted mb-0">Data Lembur</p></div></div>
        </div>
        <div class="col-md-3">
            <div class="card"><div class="card-body text-center"><h3 class="text-success">{{ $vehicleRequests->count() + $assetRequests->count() }}</h3><p class="text-muted mb-0">Kendaraan & Inventaris</p></div></div>
        </div>
    </div>
    ...
    <div class="row"><div class="col-12"><div class="card"><div class="card-header"><h4 class="card-title">Daftar Pengajuan Menunggu Approval HEAD DIVISI</h4></div><div class="card-body">
        <ul class="nav nav-tabs mb-4" id="requestTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation"><button class="nav-link" id="overtime-tab" data-toggle="tab" data-target="#overtime" type="button" role="tab"><i class="mdi mdi-clock me-1"></i> Data Lembur <span class="badge badge-warning">{{ $dataLemburCount }}</span></button></li>
            ...
            <li class="nav-item" role="presentation"><button class="nav-link" id="asset-tab" data-toggle="tab" data-target="#asset" type="button" role="tab"><i class="mdi mdi-package-variant me-1"></i> Inventaris <span class="badge badge-info">{{ $assetRequests->count() }}</span></button></li>
        </ul>
                ...
                @if($formRequests->count() > 0)
                    ...
                    @foreach($formRequests as $request)
                        <tr>
                            ...
                            <td>{!! $request->current_approval_status_text !!}</td>
                ...
                @if($dataLemburCount > 0)
                    ...
                    @foreach($splRequests ?? collect() as $spl)
                        <tr>
                            ...
                            <td><span class="badge bg-secondary text-white">{{ $spl->shift }}</span></td>
