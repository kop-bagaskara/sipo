...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Head Pending Approval</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">HR</a></li>
                <li class="breadcrumb-item active">Head Pending Approval</li>
            </ol>
        </div>
    </div>
    ...
    <!-- Statistics -->
    @php
        $totalPending = $formRequests->count() + $overtimeRequests->count() + $vehicleRequests->count() + $assetRequests->count();
    @endphp
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Daftar Pengajuan Menunggu Approval Head</h4>
                </div>
                <div class="card-body">
                    <!-- Tabs -->
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge bg-info" style="color: white;">{{ $request->request_type_label }}</span></td>
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                        ...
                                        <td>{{ $entry->employee_name }}</td>
                                                ...
                                                <td>
                                                    <a href="{{ route('hr.overtime.index') }}" class="btn btn-sm btn-outline-warning">
                                                        <i class="mdi mdi-eye"></i> Lihat
                                                    </a>
                                        </td>
                                    </tr>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('hr.vehicle-asset.index', ['type' => 'vehicle']) }}" class="btn btn-sm btn-outline-success">
                                                        <i class="mdi mdi-eye"></i> Lihat
                                                    </a>
                                                </td>
                                            </tr>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ \Illuminate\Support\Str::limit($request->destination, 30) }}</td>
                                                <td>
                                                    <a href="{{ route('hr.vehicle-asset.index', ['type' => 'asset']) }}" class="btn btn-sm btn-outline-info">
                                                        <i class="mdi mdi-eye"></i> Lihat
                                                    </a>
                                        </td>
                                    </tr>
