            ...
            <div class="card-body">
                ...
                <div class="mt-2">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio" name="scenario_type" id="scenario_self" value="self" {{ $currentScenario === 'self' ? 'checked' : '' }}>
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio" name="scenario_type" id="scenario_exchange" value="exchange" {{ $currentScenario === 'exchange' ? 'checked' : '' }}>
                    ...
                    <div class="form-check mb-0">
                        <input class="form-check-input" type="radio" name="scenario_type" id="scenario_holiday" value="holiday" {{ $currentScenario === 'holiday' ? 'checked' : '' }}>
...
<div class="row mb-3" id="date-section">
    ...
    <div class="col-md-6 d-none" id="holiday-date-section">
        ...
        <input type="date" name="holiday_work_date" id="holiday_work_date" class="form-control @error('holiday_work_date') is-invalid @enderror"
            value="{{ old('holiday_work_date', $data['holiday_work_date'] ?? '') }}">
        @error('holiday_work_date')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    ...
    <div class="col-md-6 d-none" id="compensatory-date-section">
        ...
        <input type="date" name="compensatory_date" id="compensatory_date" class="form-control @error('compensatory_date') is-invalid @enderror"
            value="{{ old('compensatory_date', $data['compensatory_date'] ?? '') }}">
        @error('compensatory_date')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
...
<div class="row mb-3" id="applicant-info-section">
    <div class="col-md-4">
        ...
        <input type="text" name="applicant_name" class="form-control @error('applicant_name') is-invalid @enderror"
            value="{{ old('applicant_name', $data['applicant_name'] ?? ($data['employee_name'] ?? auth()->user()->name)) }}" readonly>
    ...
    <div class="col-md-4">
        ...
        <input type="text" name="applicant_nip" class="form-control @error('applicant_nip') is-invalid @enderror"
            value="{{ old('applicant_nip', $data['applicant_nip'] ?? ($data['employee_nip'] ?? '')) }}" readonly>
        @error('applicant_nip')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-4">
        ...
        <input type="text" name="applicant_department"
            class="form-control @error('applicant_department') is-invalid @enderror"
            value="{{ old('applicant_department', $data['applicant_department'] ?? ($data['employee_department'] ?? '')) }}"
            readonly>
        @error('applicant_department')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
</div>
...
<div class="row mb-3 d-none" id="self-shift-section">
    ...
    <div class="col-md-3">
        ...
        <input type="time" name="original_start_time"
            class="form-control @error('original_start_time') is-invalid @enderror"
            value="{{ old('original_start_time', $data['original_start_time'] ?? '') }}" placeholder="Contoh: 07:00">
        @error('original_start_time')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    ...
    <div class="col-md-3">
        ...
        <input type="time" name="original_end_time"
            class="form-control @error('original_end_time') is-invalid @enderror"
            value="{{ old('original_end_time', $data['original_end_time'] ?? '') }}" placeholder="Contoh: 15:00">
        @error('original_end_time')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
        <small class="text-muted">Jam shift saat ini</small>
    </div>
    <div class="col-md-3">
        ...
        <input type="time" name="new_start_time"
            class="form-control @error('new_start_time') is-invalid @enderror"
            value="{{ old('new_start_time', $data['new_start_time'] ?? '') }}" placeholder="Contoh: 08:00">
    ...
    <div class="col-md-3">
        ...
        <input type="time" name="new_end_time"
            class="form-control @error('new_end_time') is-invalid @enderror"
            value="{{ old('new_end_time', $data['new_end_time'] ?? '') }}" placeholder="Contoh: 16:00">
        @error('new_end_time')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
        <small class="text-muted">Jam shift yang diinginkan</small>
...
<div class="row mb-3" id="applicant-shift-section">
    <div class="col-md-4">
        ...
        <input type="time" name="applicant_start_time"
            class="form-control @error('applicant_start_time') is-invalid @enderror"
            value="{{ old('applicant_start_time', $data['applicant_start_time'] ?? '') }}" required>
        @error('applicant_start_time')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-4">
        ...
        <input type="time" name="applicant_end_time"
            class="form-control @error('applicant_end_time') is-invalid @enderror"
            value="{{ old('applicant_end_time', $data['applicant_end_time'] ?? '') }}" required>
        @error('applicant_end_time')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-4">
        ...
        <input type="text" name="purpose" class="form-control @error('purpose') is-invalid @enderror"
            value="{{ old('purpose', $data['purpose'] ?? '') }}" placeholder="Alasan tukar shift" required>
        @error('purpose')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
...
<div class="row mb-3 d-none" id="holiday-hours-section">
    <div class="col-md-6">
        ...
        <input type="number" name="work_hours" class="form-control @error('work_hours') is-invalid @enderror"
            value="{{ old('work_hours', $data['work_hours'] ?? '') }}" step="0.5" min="0" placeholder="Contoh: 8">
        @error('work_hours')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
...
<div class="row mb-3 d-none" id="substitute-info-section">
    ...
    <div class="col-md-6">
        ...
        <input type="hidden" name="substitute_id" id="substitute_id" value="{{ old('substitute_id', $data['substitute_id'] ?? '') }}">
        <select name="substitute_name" id="substitute_name" class="form-control @error('substitute_name') is-invalid @enderror" style="width: 100%;">
            <option value="">-- Pilih Karyawan Pengganti --</option>
            @foreach($data['same_division_employees'] ?? [] as $employee)
                <option value="{{ $employee['name'] }}"
                        data-id="{{ $employee['id'] }}"
                        data-nip="{{ $employee['nip'] }}"
                        data-department="{{ $employee['division_name'] }}"
                        {{ old('substitute_name', $data['substitute_name'] ?? '') == $employee['name'] ? 'selected' : '' }}>
    ...
    <div class="col-md-3">
        ...
        <input type="text" name="substitute_nip" id="substitute_nip" class="form-control @error('substitute_nip') is-invalid @enderror"
            value="{{ old('substitute_nip', $data['substitute_nip'] ?? '') }}" readonly>
        @error('substitute_nip')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-3">
        ...
        <input type="text" name="substitute_department" id="substitute_department"
            class="form-control @error('substitute_department') is-invalid @enderror"
            value="{{ old('substitute_department', $data['substitute_department'] ?? '') }}" readonly>
        @error('substitute_department')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
</div>
...
<div class="row mb-3 d-none" id="substitute-shift-section">
    <div class="col-md-4">
        ...
        <input type="time" name="substitute_start_time"
            class="form-control @error('substitute_start_time') is-invalid @enderror"
            value="{{ old('substitute_start_time', $data['substitute_start_time'] ?? '') }}">
        @error('substitute_start_time')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-4">
        ...
        <input type="time" name="substitute_end_time"
            class="form-control @error('substitute_end_time') is-invalid @enderror"
            value="{{ old('substitute_end_time', $data['substitute_end_time'] ?? '') }}">
        @error('substitute_end_time')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-4">
        ...
        <input type="text" name="substitute_purpose"
            class="form-control @error('substitute_purpose') is-invalid @enderror"
            value="{{ old('substitute_purpose', $data['substitute_purpose'] ?? '') }}" placeholder="Alasan pengganti">
        @error('substitute_purpose')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
</div>
...
$(document).ready(function() {
            ...
            success: function(response) {
                if (response.is_holiday && !isUpdate) {
                    ...
                    Swal.fire({
                        ...
                        window.location.href = response.redirect || '{{ route("hr.requests.index") }}';
                    });
                }
            },
            error: function(xhr) {
    ...
    function submitWithConfirmation(formData) {
        $.ajax({
            url: '{{ route("hr.requests.store.confirm") }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
