            ...
            <div class="col-md-3">
                ...
                @if (Auth::user()->jabatan == 5 || Auth::user()->jabatan == 4 || Auth::user()->jabatan == 3 || (method_exists(Auth::user(), 'isHR') && Auth::user()->isHR()))
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Pending Approval 1</h4>
                ...
                <div class="card">
                    <div class="card-header" style="overflow: hidden;">
                        <h4 class="card-title" style="word-wrap: break-word; overflow-wrap: break-word; white-space: normal; word-break: break-word; margin: 0;">Grafik Izin per Department</h4>
                    </div>
                    <div class="card-body">
                        <!-- Filter Section -->
                        <div class="row mb-3">
                        ...
                        <div id="chartNoDataMessage" class="text-center text-muted mt-3" style="word-wrap: break-word; overflow-wrap: break-word; white-space: normal; word-break: break-word; display: none;">
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <select class="form-control" id="requestFilter"
                                                                    ...
                                                                    <option value="overtime"
                                                                        {{ request('filter_type') == 'overtime' ? 'selected' : '' }}>
                                                                        Data Lembur</option>
                                                                    ...
                                                                    @foreach ($assetRequests as $request)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                @endphp
                                                                                <span
                                                                                    class="badge badge-{{ $status['class'] }}" style="color: white;">{{ $status['text'] }}</span>
                                                                            </td>
                                                                            <td>
                                                    ...
                                                    @if (isset($splRequests) && $splRequests->count() > 0)
                                                        <div class="table-responsive">
                                                            <table id="splTable"
                                                                ...
                                                                <thead class="table-warning">
                                                                    <tr>
                                                                        <th><i class="mdi mdi-file-document-outline me-1"></i>
                                                                            No. SPL</th>
                                                                        <th><i class="mdi mdi-calendar me-1"></i> Tanggal</th>
                                                                        <th><i class="mdi mdi-clock me-1"></i> Shift</th>
                                                                        <th><i class="mdi mdi-account me-1"></i> Supervisor</th>
                                                                        <th><i class="mdi mdi-account-group me-1"></i> Jumlah
                                                                            Karyawan</th>
                                                                        <th><i class="mdi mdi-flag me-1"></i> Status</th>
                                                                        <th><i class="mdi mdi-cog me-1"></i> Aksi</th>
                                                                    </tr>
                                                    ...
                                                    @else
                                                        <div class="text-center py-5">
                                                            ...
                                                            <p class="text-muted">Belum ada Surat Perintah Lembur yang
                                                                tercatat.</p>
                                                            <a href="{{ route('hr.spl.create') }}" class="btn btn-warning">
    ...
    @section('scripts')
        ...
        <script>
            ...
            function initializeCalendar() {
                ...
                window.calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    events: function(info, successCallback, failureCallback) {
                        ...
                        fetch('{{ route('hr.requests.calendar-events') }}')
                            .then(response => {
                            ...
                            .catch(error => {
                                ...
                                // Show some test events if API fails
                                const testEvents = [{
                                        id: 'test_1',
                                    ...
                                    },
                                    {
                                        ...
                                        extendedProps: {
                                            ...
                                            status: 'approved',
                                            notes: 'Test overtime event'
                                        }
                                    }
                                ];
                                console.log('Using fallback test events:', testEvents);
            ...
            function showEventDetails(event) {
                ...
                fetch(`{{ route('hr.requests.calendar-request-details') }}?date=${date}&type=${type}&request_ids=${requestIds.join(',')}`)
                        ...
                        if (result.success && result.data && result.data.length > 0) {
                            ...
                            result.data.forEach((item, index) => {
                                const statusBadgeClass = item.status === 'pending' ? 'warning' :
                                                         ...
                                                         item.status === 'hr_rejected' || item.status === 'supervisor_rejected' ? 'danger' : 'info';
            ...
            function loadDepartmentAbsenceChart() {
                ...
                // Fetch data from API
                fetch(`{{ route('hr.requests.department-absence-stats') }}?department_id=${departmentId}&month=${month}`)
                    .then(response => response.json())
                    .then(result => {
                        btn.disabled = false;
