                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('hr.applicants.index') }}" class="btn btn-secondary btn-sm">
                                <i class="mdi mdi-arrow-left"></i> Kembali
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <form id="applicantForm" method="POST" action="{{ route('hr.applicants.update', $applicant) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '{{ route("hr.applicants.show", $applicant) }}';
                        });
                    },
                    error: function(xhr) {
                        Swal.close();
