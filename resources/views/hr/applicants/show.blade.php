    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('hr.applicants.index') }}">Data Pelamar</a></li>
    ...
    <div class="row">
        ...
        <div class="col-12 mb-3">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <a href="{{ route('public.applicant.edit', $applicant) }}" class="btn btn-info">
                        <i class="mdi mdi-pencil"></i> Edit
                    </a>
                    <a href="{{ route('public.applicant.tests', $applicant) }}" class="btn btn-success">
                        <i class="mdi mdi-clipboard-text"></i> Test
                    </a>
                    <a href="{{ route('public.applicant.test.results', $applicant) }}" class="btn btn-primary">
