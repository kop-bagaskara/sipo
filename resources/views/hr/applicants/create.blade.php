        ...
        <div class="row">
            <div class="col-12" id="applicantForm">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('public.applicant.store') }}" method="POST"
        ...
        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="progress" style="height: 25px;">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated"
                                        ...
                                        <span id="testProgressText" class="font-weight-bold">0 dari 4 test
                                            selesai</span>
                                    </div>
                                </div>
                            </div>
            ...
            <script>
                ...
                function saveCurrentTab() {
                    ...
                    // Send AJAX request
                    var storeUrl = '{{ route('public.applicant.store') }}';
                                    ...
                                    if (currentTab === 'kemampuan') {
                                        ...
                                        if (applicantId) {
                                            ...
                                            window.location.href =
                                                '{{ route('public.applicant.create') }}?id=' + applicantId
                                        } else {
                ...
                function createSimpleTestList(applicantId) {
                    var testTypes = [{
                        ...
                        //     type: 'test_2',
                        //     name: 'Tes Krapelin'
                        // }, // Sementara dinonaktifkan - mencari formula penilaian
                        {
                            type: 'test_3',
                            name: 'Tes Buta Warna'
                        },
                    ...
                    var testResultsUrl = '{{ url('sipo/hr') }}/' + applicantId + '/test-results-json?' + new Date().getTime()
                    $.ajax({
                        url: testResultsUrl,
                        method: 'GET',
                        dataType: 'json',
                        ...
                        success: function(response) {
                            ...
                            var baseUrl = '{{ url('sipo/hr') }}/' + applicantId + '/test'
                        ...
                        error: function() {
                            ...
                            var baseUrl = '{{ url('sipo/hr/applicants') }}'
                            var html = '<div class="table-responsive">' +
                                '<table class="table table-bordered table-striped">' +
                                '<thead>' +
                                '<tr>' +
                ...
                function finishTestProcess() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            // Submit request
                            var finishUrl = '{{ url("sipo/hr") }}/' + applicantId + '/finish-test-process';
                            $.ajax({
                                url: finishUrl,
                                method: 'POST',
                                headers: {
                                ...
                                success: function(response) {
                                    if (response.success) {
                                        Swal.fire({
                                            ...
                                            window.location.href = '{{ url("sipo/hr") }}/' + applicantId + '/test-completed'
                                        })
                                    } else {
                                        Swal.fire({
                                            icon: 'error',
