                            ...
                            <div class="row video-fields" style="display: {{ $session->has_video ? 'block' : 'none' }};">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            name="sessions[{{ $session->session_order }}][video_input]"
                                        ...
                                        <input type="hidden" name="sessions[{{ $session->session_order }}][video_url]"
                                            class="video-url-hidden"
                                            value="{{ $session->video_url }}">
                                        <input type="hidden" name="sessions[{{ $session->session_order }}][google_drive_file_id]"
                                            class="google-drive-hidden"
                                            value="{{ $session->google_drive_file_id }}">
                                        <input type="hidden" name="sessions[{{ $session->session_order }}][video_source]"
