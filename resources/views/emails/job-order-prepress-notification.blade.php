    ...
    <div class="email-container">
        ...
        <div class="job-details">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value"><strong>{{ $jobOrder->kode_design }}</strong></span>
            </div>
            
            <div class="detail-row">
                <span class="detail-label">Product:</span>
                <span class="detail-value">{{ $jobOrder->product }}</span>
            </div>
            
            <div class="detail-row">
                <span class="detail-label">Customer:</span>
                <span class="detail-value">{{ $jobOrder->customer }}</span>
            </div>
            
            <div class="detail-row">
                <span class="detail-label">Job Type:</span>
                <span class="detail-value">{{ $jobOrder->job_order }}</span>
            </div>
            
            <div class="detail-row">
                <span class="detail-label">Quantity:</span>
                <span class="detail-value">
                    @if(is_numeric($jobOrder->qty_order_estimation))
                        {{ number_format((float)$jobOrder->qty_order_estimation) }}
                    @else
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">{{ \Carbon\Carbon::parse($jobOrder->tanggal_job_order)->format('d/m/Y') }}</span>
            </div>
            
            <div class="detail-row">
                <span class="detail-label">Deadline:</span>
                <span class="detail-value">
                    @if($jobOrder->tanggal_deadline)
                        {{ \Carbon\Carbon::parse($jobOrder->tanggal_deadline)->format('d/m/Y') }}
                    @else
                        -
                    @endif
                </span>
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">
                    <span class="priority-badge priority-{{ strtolower($jobOrder->prioritas_job) }}">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">{{ $jobOrder->created_by }}</span>
            </div>
        </div>
        ...
        <div class="job-details">
            ...
            <p style="margin: 0; font-style: italic;">{{ $jobOrder->catatan }}</p>
        </div>
        @endif
