...
<head>
    ...
    <title>Update Status Supplier Ticket</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>📋 Update Status Supplier Ticket</h1>
        <p>Status supplier ticket telah diperbarui</p>
    </div>
    ...
    <div class="content">
        ...
        <div class="status-change">
            <div class="info-row">
                <div class="info-label">Status Sebelumnya:</div>
                <div class="info-value">
                    <span class="status status-{{ strtolower($oldStatus) }}">
                        {{ ucfirst($oldStatus) }}
                    </span>
                </div>
            </div>
            ...
            <div class="info-row">
                ...
                <div class="info-value">
                    <span class="status status-{{ strtolower($newStatus) }}">
                        {{ ucfirst($newStatus) }}
                    </span>
        ...
        <div class="ticket-info">
            ...
            <div class="info-row">
                ...
                <div class="info-value">{{ $supplierTicket->updated_at->format('d/m/Y H:i') }}</div>
            </div>
