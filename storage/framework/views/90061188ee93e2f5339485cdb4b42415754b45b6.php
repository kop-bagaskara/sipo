    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        <script>
            $(document).ready(function() {
                ...
                var datatable2 = initDataTable("<?php echo e(route('prepress.plan-selected.data')); ?>", csrfToken);

                // Saat tombol #btn-work-order diklik
                $('#btn-work-order').click(function() {
                    datatable2.clear().destroy();
                    datatable2 = initDataTable("<?php echo e(route('prepress.plan-selected.data-work-order')); ?>",
                        csrfToken);
                });
                ...
                $('#btn-job-order').click(function() {
                    datatable2.clear().destroy();
                    datatable2 = initDataTable("<?php echo e(route('prepress.plan-selected.data')); ?>", csrfToken);
                });
                ...
                $('body').on('click', '.assign-job', function() {
                    ...
                    var url = "<?php echo e(route('prepress.job-order.assign-job', ['id' => 'ID_PLACEHOLDER'])); ?>";
                ...
                $('body').on('click', '.assign-job-wo', function() {
                    var id = $(this).data('id');
                    var url = "<?php echo e(route('prepress.work-order.assign-job', ['id' => 'ID_PLACEHOLDER'])); ?>";
                    url = url.replace('ID_PLACEHOLDER', id);
                ...
                var routeAssignJob = "<?php echo e(route('prepress.job-order.assign-user')); ?>";
                ...
                $('#submitRejectJob').submit(function(e) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('prepress.job-order.reject-job-order')); ?>",
                        type: 'POST',
                        data: formData,
                        dataType: 'json',
                        beforeSend: function(xhr) {
                ...
                $('body').on('click', '.delete-job-order', function() {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            var id = $(this).data('id');
                            var url =
                                "<?php echo e(route('prepress.job-order.delete-job-order-wo', ['id' => 'ID_PLACEHOLDER'])); ?>";
                            url = url.replace('ID_PLACEHOLDER', id);
                            $.ajax({
                                url: url,
                                type: 'POST',
            ...
            function loadPicLoadData() {
                $.ajax({
                    url: "<?php echo e(route('prepress.dashboard.load-data')); ?>",
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
            ...
            function loadDetailJobs(picId) {
                ...
                var url = "<?php echo e(route('prepress.dashboard.detail-jobs', ['id' => 'ID_PLACEHOLDER'])); ?>";
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/process/prepress/data/data-listplan.blade.php ENDPATH**/ ?>