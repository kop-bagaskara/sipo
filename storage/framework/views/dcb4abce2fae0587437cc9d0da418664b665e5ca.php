...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('name', $data['name'] ?? auth()->user()->name)); ?>" required readonly>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="gender" class="form-control"
                            value="<?php echo e(old('gender', $data['employee_gender'] ?? '')); ?>" required readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('department', $data['department'] ?? (auth()->user()->divisiUser->divisi ?? ''))); ?>" required
                            readonly>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="absence_type" id="absence_type"
                            class="form-select form-control <?php $__errorArgs = ['absence_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php if(isset($data['absenceSettings'])): ?>
                                <?php $__currentLoopData = $data['absenceSettings']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $absenceType => $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($absenceType); ?>" <?php echo e(old('absence_type') == $absenceType ? 'selected' : ''); ?>>
                                        <?php echo e($absenceType); ?>

                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
                        <?php $__errorArgs = ['absence_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('duration_days', $data['duration_days'] ?? '')); ?>" min="1" required
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="cuti_khusus_category" id="cuti_khusus_category_select" class="form-select form-control">
                            ...
                            <?php if(isset($data['absenceSettings']['CUTI KHUSUS']['master_sub_absence'])): ?>
                                <?php $__currentLoopData = $data['absenceSettings']['CUTI KHUSUS']['master_sub_absence']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sub['name']); ?>"
                                        <?php echo e(old('cuti_khusus_category') == $sub['name'] ? 'selected' : ''); ?>>
                                        <?php echo e($sub['name']); ?> (<?php echo e($sub['duration_days']); ?> hari)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                            <option value="Lainnya" <?php echo e(old('cuti_khusus_category') == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                        </select>
                    ...
                    <div class="col-md-6" id="cuti_khusus_other" style="display: none;">
                        ...
                        <input type="text" name="cuti_khusus_other_text" id="cuti_khusus_other_text" class="form-control"
                            value="<?php echo e(old('cuti_khusus_other_text', '')); ?>" placeholder="Tuliskan keterangan cuti khusus secara detail">
                        <div class="form-text text-muted mt-1">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="dinas_category" id="dinas_category"
                            class="form-select form-control <?php $__errorArgs = ['dinas_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="">-- Pilih Kategori --</option>
                            <option value="VISIT JAKARTA" <?php echo e(old('dinas_category') == 'VISIT JAKARTA' ? 'selected' : ''); ?>>VISIT JAKARTA</option>
                            <option value="JAWA TENGAH" <?php echo e(old('dinas_category') == 'JAWA TENGAH' ? 'selected' : ''); ?>>JAWA TENGAH</option>
                            <option value="BALI" <?php echo e(old('dinas_category') == 'BALI' ? 'selected' : ''); ?>>BALI</option>
                            <option value="DEMO" <?php echo e(old('dinas_category') == 'DEMO' ? 'selected' : ''); ?>>DEMO</option>
                            <option value="TRAINING" <?php echo e(old('dinas_category') == 'TRAINING' ? 'selected' : ''); ?>>TRAINING</option>
                            <option value="JOB FAIR" <?php echo e(old('dinas_category') == 'JOB FAIR' ? 'selected' : ''); ?>>JOB FAIR</option>
                            <option value="SEMINAR" <?php echo e(old('dinas_category') == 'SEMINAR' ? 'selected' : ''); ?>>SEMINAR</option>
                            <option value="PSIKOTES" <?php echo e(old('dinas_category') == 'PSIKOTES' ? 'selected' : ''); ?>>PSIKOTES</option>
                            <option value="WORKSHOP" <?php echo e(old('dinas_category') == 'WORKSHOP' ? 'selected' : ''); ?>>WORKSHOP</option>
                        </select>
                        <?php $__errorArgs = ['dinas_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="dinas_purpose" id="dinas_purpose_input"
                            class="form-control <?php $__errorArgs = ['dinas_purpose'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="3"
                            placeholder="Contoh: Kunjungan ke client PT. XYZ di Jakarta untuk demo produk. Alamat: Jl. Sudirman No. 123, Jakarta Selatan." required><?php echo e(old('dinas_purpose', '')); ?></textarea>
                        <?php $__errorArgs = ['dinas_purpose'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="ijin_category" id="ijin_category"
                            class="form-select form-control <?php $__errorArgs = ['ijin_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="">-- Pilih Kategori --</option>
                            <option value="KEMATIAN" <?php echo e(old('ijin_category') == 'KEMATIAN' ? 'selected' : ''); ?>>KEMATIAN</option>
                            <option value="ACARA KELUARGA" <?php echo e(old('ijin_category') == 'ACARA KELUARGA' ? 'selected' : ''); ?>>ACARA KELUARGA</option>
                            <option value="PERNIKAHAN" <?php echo e(old('ijin_category') == 'PERNIKAHAN' ? 'selected' : ''); ?>>PERNIKAHAN</option>
                            <option value="KEPENTINGAN PRIBADI" <?php echo e(old('ijin_category') == 'KEPENTINGAN PRIBADI' ? 'selected' : ''); ?>>KEPENTINGAN PRIBADI</option>
                            <option value="KELAHIRAN" <?php echo e(old('ijin_category') == 'KELAHIRAN' ? 'selected' : ''); ?>>KELAHIRAN</option>
                            <option value="KELUARGA SAKIT" <?php echo e(old('ijin_category') == 'KELUARGA SAKIT' ? 'selected' : ''); ?>>KELUARGA SAKIT</option>
                        </select>
                        <?php $__errorArgs = ['ijin_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6" id="ijin_purpose_field" style="display: none;">
                        ...
                        <textarea name="ijin_purpose" id="ijin_purpose" class="form-control <?php $__errorArgs = ['ijin_purpose'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            rows="3" placeholder="Contoh: Izin untuk menghadiri pernikahan saudara di Surabaya. Acara pada hari Sabtu, 25 Januari 2025." required><?php echo e(old('ijin_purpose', '')); ?></textarea>
                        <?php $__errorArgs = ['ijin_purpose'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('date_start', $data['date_start'] ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?> bg-light"
                            value="<?php echo e(old('date_end', $data['date_end'] ?? '')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('purpose', $data['purpose'] ?? '')); ?>" placeholder="Alasan tidak masuk kerja" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="remaining_annual_leave" id="remaining_annual_leave"
                                class="form-control <?php $__errorArgs = ['remaining_annual_leave'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> bg-white"
                                value="<?php echo e(old('remaining_annual_leave', $data['remaining_annual_leave'] ?? ($data['remainingAnnualLeave'] ?? 0))); ?>"
                                min="0" readonly>
                            <span class="input-group-text">hari</span>
                        </div>
                        <?php $__errorArgs = ['remaining_annual_leave'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="hpl_date" id="hpl_date"
                                class="form-control <?php $__errorArgs = ['hpl_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('hpl_date', $data['hpl_date'] ?? '')); ?>">
                        </div>
                        <?php $__errorArgs = ['hpl_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        const absenceSettings = <?php echo json_encode($data['absenceSettings'] ?? [], 15, 512) ?>;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const absenceTypeReminders = {
                ...
                'CUTI TAHUNAN': {
                    title: '🏖️ Informasi Cuti Tahunan',
            ...
            const absenceFormElement = document.querySelector('form[action="<?php echo e(route('hr.requests.store')); ?>"]');
            ...
            if (absenceFormElement) {
                ...
                if (requestTypeInput && requestTypeInput.value === 'absence') {
                    ...
                    const submitAbsenceWithConfirmation = () => {
                        ...
                        fetch('<?php echo e(route('hr.requests.store.confirm')); ?>', {
                                method: 'POST',
                                headers: {
...
<?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/requests/forms/absence.blade.php ENDPATH**/ ?>