    ...
    <?php $__env->startSection('content'); ?>
            ...
            <div class="col-12">
                <div class="card border-info">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h6><i class="mdi mdi-account-check me-2"></i>Sebagai SPV (Jabatan <?php echo e(Auth::user()->jabatanUser->jabatan); ?>)</h6>
                                    ...
                                    <li>
                                        ...
                                        <?php if($approvalInfo['can_approve_absence']): ?>
                                            ...
                                            <?php if(!empty($approvalInfo['absence_approval_order'])): ?>
                                                <div class="mt-2">
                                                    <small class="text-muted d-block mb-1"><strong>Urutan Approval untuk Divisi <?php echo e(Auth::user()->divisiUser->divisi); ?>:</strong></small>
                                                    <ol class="mb-0" style="padding-left: 20px;">
                                                        <?php $__currentLoopData = $approvalInfo['absence_approval_order']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="mb-1">
                                                                <span class="badge badge-<?php echo e($orderItem['enabled'] ? 'primary' : 'secondary'); ?>">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <small class="text-muted d-block">SPV disabled untuk divisi <?php echo e(Auth::user()->divisiUser->divisi); ?></small>
                                        <?php endif; ?>
                                    </li>
                                    <li class="mt-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mb-2"><strong>Divisi Anda:</strong> <?php echo e(Auth::user()->divisiUser->divisi); ?></p>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        <h3 class="text-warning"><?php echo e($overtimeRequests->count()); ?></h3>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs mb-4" id="requestTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="overtime-tab" data-toggle="tab" data-target="#overtime"
                                    ...
                                    <span class="badge badge-warning"><?php echo e($overtimeRequests->count()); ?></span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="requestTabsContent">
                                                        ...
                                                        <td>
                                                            <?php if($request->employee && $request->employee->divisiUser): ?>
                                                                <span class="badge badge-secondary">
                                                                    <?php echo e($request->employee->divisiUser->divisi ?? 'Divisi ' . $request->employee->divisi); ?>
                            ...
                            <div class="tab-pane fade" id="overtime" role="tabpanel">
                                <?php if($overtimeRequests->count() > 0): ?>
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $overtimeRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(\Illuminate\Support\Str::limit($entry->location, 30)); ?></td>
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/approval/supervisor-pending.blade.php ENDPATH**/ ?>