    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#datatable-trainings').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('hr.portal-training.master.training-masters.getData')); ?>",
                columns: [
            ...
            $('#addTrainingForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('hr.portal-training.master.training-masters.store')); ?>",
                    type: 'POST',
                    data: formData,
            ...
            $(document).on('click', '.btn-view', function() {
                ...
                $.get("<?php echo e(route('hr.portal-training.master.training-masters.index')); ?>/" + id, function(data) {
                    let content = `
            ...
            $(document).on('click', '.btn-edit', function() {
                const id = $(this).data('id');
                const editUrl = "<?php echo e(route('hr.portal-training.master.training-masters.index')); ?>/" + id + "/edit";
                const updateUrl = "<?php echo e(route('hr.portal-training.master.training-masters.index')); ?>/" + id;
            ...
            $(document).on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(route('hr.portal-training.master.training-masters.index')); ?>/" + id,
                            type: 'DELETE',
                            data: {
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/portal-training/master/training-masters/index.blade.php ENDPATH**/ ?>