        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="<?php echo e(route('hr.vehicle-asset.index', ['type' => $type])); ?>">
                        <?php if($type === 'vehicle'): ?>
                            Kendaraan
                        <?php else: ?>
                            Inventaris
    ...
    <div class="row">
        ...
        <div class="col ">
            <div class="card shadow-sm">
                <div class="card-header text-white <?php if($type === 'vehicle'): ?> bg-info <?php else: ?> bg-success <?php endif; ?> text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="card-title mb-0 text-white"><i class="mdi <?php if($type === 'vehicle'): ?> mdi-car <?php else: ?> mdi-package-variant <?php endif; ?> me-2"></i>Form Permintaan <?php echo e($type === 'vehicle' ? 'Kendaraan' : 'Inventaris'); ?></h4>
                            <p class="card-subtitle mb-0 text-white-50 small mt-1">Isi data lengkap untuk pengajuan <?php echo e($type === 'vehicle' ? 'kendaraan' : 'inventaris'); ?></p>
                        </div>
                        <div class="text-end">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('hr.vehicle-asset.store')); ?>" id="vehicleAssetForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="employee_name" class="form-control <?php $__errorArgs = ['employee_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('employee_name', Auth::user()->name)); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('department', Auth::user()->divisiUser->divisi ?? 'N/A')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-section" id="step2">
                            <h5 class="form-section-title">
                                <i class="<?php if($type === 'vehicle'): ?> mdi-car <?php else: ?> mdi-package-variant <?php endif; ?>"></i>
                                Detail <?php echo e($type === 'vehicle' ? 'Kendaraan' : 'Inventaris'); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">
                                    <i class="mdi mdi-tag me-1 text-muted"></i>Jenis <?php echo e($type === 'vehicle' ? 'Kendaraan' : 'Barang'); ?>

                                    <span class="text-danger">*</span>
                                    <i class="mdi mdi-help-circle text-info ms-1" data-toggle="tooltip"
                                        data-placement="right" title="Pilih jenis <?php if($type === 'vehicle'): ?> kendaraan <?php else: ?> inventaris/inventaris <?php endif; ?> yang akan dipinjam"></i>
                                </label>
                                <select name="<?php echo e($type === 'vehicle' ? 'vehicle_type' : 'asset_category'); ?>"
                                        id="item_type_select"
                                        class="form-select form-control <?php $__errorArgs = [$type === 'vehicle' ? 'vehicle_type' : 'asset_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php if($type === 'vehicle'): ?>
                                        <optgroup label="🚗 Kendaraan">
                                            <option value="Mobil" <?php echo e(old('vehicle_type') == 'Mobil' ? 'selected' : ''); ?>>Mobil</option>
                                            <option value="Motor" <?php echo e(old('vehicle_type') == 'Motor' ? 'selected' : ''); ?>>Motor</option>
                                        </optgroup>
                                    <?php else: ?>
                                        <optgroup label="💻 Inventaris">
                                            <option value="Laptop" <?php echo e(old('asset_category') == 'Laptop' ? 'selected' : ''); ?>>Laptop Company</option>
                                            <option value="Lain-Lain" <?php echo e(old('asset_category') == 'Lain-Lain' ? 'selected' : ''); ?>>Inventaris Lain-lain</option>
                                        </optgroup>
                                    <?php endif; ?>
                                </select>
                                <?php $__errorArgs = [$type === 'vehicle' ? 'vehicle_type' : 'asset_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">
                                    ...
                                    <span class="text-danger">*</span>
                                    <i class="mdi mdi-help-circle text-info ms-1" data-toggle="tooltip"
                                        data-placement="right" title="Pilih tujuan penggunaan <?php if($type === 'vehicle'): ?> kendaraan <?php else: ?> inventaris <?php endif; ?>"></i>
                                </label>
                                <select name="purpose_type" class="form-select form-control <?php $__errorArgs = ['purpose_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="Meeting" <?php echo e(old('purpose_type') == 'Meeting' ? 'selected' : ''); ?>>📅 Meeting</option>
                                    <option value="Dinas Luar" <?php echo e(old('purpose_type') == 'Dinas Luar' ? 'selected' : ''); ?>>🏢 Dinas Luar</option>
                                    <option value="Training" <?php echo e(old('purpose_type') == 'Training' ? 'selected' : ''); ?>>📚 Training</option>
                                    <option value="Presentasi" <?php echo e(old('purpose_type') == 'Presentasi' ? 'selected' : ''); ?>>📊 Presentasi</option>
                                    <option value="Lainnya" <?php echo e(old('purpose_type') == 'Lainnya' ? 'selected' : ''); ?>>📋 Lainnya</option>
                                </select>
                                <?php $__errorArgs = ['purpose_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label class="form-label fw-semibold">
                                    ...
                                    <span class="text-danger">*</span>
                                    <i class="mdi mdi-help-circle text-info ms-1" data-toggle="tooltip"
                                        data-placement="right" title="Jelaskan detail keperluan penggunaan <?php if($type === 'vehicle'): ?> kendaraan <?php else: ?> inventaris <?php endif; ?>"></i>
                                </label>
                                <textarea name="purpose" class="form-control <?php $__errorArgs = ['purpose'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="3"
                                          placeholder="Contoh: <?php if($type === 'vehicle'): ?> Menghadiri meeting dengan client PT. XYZ di Jakarta untuk presentasi produk. <?php else: ?> Mengikuti training di luar kota dan membutuh laptop untuk presentasi. <?php endif; ?>" required><?php echo e(old('purpose')); ?></textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <label class="form-label fw-semibold">
                                    ...
                                    <span class="text-danger">*</span>
                                    <i class="mdi mdi-help-circle text-info ms-1" data-toggle="tooltip"
                                        data-placement="right" title="Lokasi tujuan penggunaan <?php if($type === 'vehicle'): ?> kendaraan <?php else: ?> inventaris <?php endif; ?>"></i>
                                </label>
...
unset($__errorArgs, $__bag); ?>" name="destination"
                                       placeholder="<?php if($type === 'vehicle'): ?>Contoh: Jakarta - Gedung Menara Sudirman Lt. 15 <?php else: ?> Contoh: Hotel XYZ - Ballroom A <?php endif; ?>"
                                       value="<?php echo e(old('destination')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">
                                    <i class="mdi <?php if($type === 'vehicle'): ?> mdi-card-text <?php else: ?> mdi-barcode <?php endif; ?> me-1 text-muted"></i><?php if($type === 'vehicle'): ?> No. Pol <?php else: ?> Kode <?php endif; ?>
                                    <i class="mdi mdi-help-circle text-info ms-1" data-toggle="tooltip"
                                        data-placement="right" title="<?php if($type === 'vehicle'): ?> Nomor polisi kendaraan (opsional) <?php else: ?> Kode inventaris (opsional) <?php endif; ?>"></i>
                                </label>
                                <input type="text" class="form-control <?php $__errorArgs = ['license_plate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="license_plate"
                                       placeholder="<?php if($type === 'vehicle'): ?> Contoh: B 1234 XYZ <?php else: ?> Contoh: INV-001 <?php endif; ?>"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">
                                    ...
                                    <span class="text-danger">*</span>
                                    <i class="mdi mdi-help-circle text-info ms-1" data-toggle="tooltip"
                                        data-placement="right" title="Tanggal mulai penggunaan <?php if($type === 'vehicle'): ?> kendaraan <?php else: ?> inventaris <?php endif; ?>"></i>
                                </label>
                                <input type="date" id="start_date" class="form-control <?php $__errorArgs = ['start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">
                                    ...
                                    <span class="text-danger">*</span>
                                    <i class="mdi mdi-help-circle text-info ms-1" data-toggle="tooltip"
                                        data-placement="right" title="Tanggal selesai penggunaan <?php if($type === 'vehicle'): ?> kendaraan <?php else: ?> inventaris <?php endif; ?>"></i>
                                </label>
                                <input type="date" id="end_date" class="form-control <?php $__errorArgs = ['end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="notes" rows="2"
                                          placeholder="<?php if($type === 'vehicle'): ?> Contoh: Harap bensin terisi sebelum digunakan. <?php else: ?> Contoh: Sudah terinstall software yang diperlukan. <?php endif; ?>"><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>>
                        ...
                        <div class="d-flex justify-content-between gap-2 pt-3">
                            <a href="<?php echo e(route('hr.vehicle-asset.index', ['type' => $type])); ?>" class="btn btn-outline-secondary">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function toggleFields() {
            const requestType = '<?php echo e($type); ?>';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    const assetType = '<?php echo e($type === 'vehicle' ? 'kendaraan' : 'inventaris'); ?>';
                    const confirmColor = '<?php echo e($type === 'vehicle' ? '#17a2b8' : '#198754'); ?>';
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/vehicle-asset/create.blade.php ENDPATH**/ ?>