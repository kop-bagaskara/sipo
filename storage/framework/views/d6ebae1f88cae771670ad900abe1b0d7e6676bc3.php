            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="submitJobPrepress" method="POST" action="<?php echo e(route('prepress.job-order.submit-new')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row d-none d-md-flex">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="tanggal" class="form-control" value="<?php echo e(date('Y-m-d')); ?>"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                function initializeDatePickers() {
                    ...
                    if ($('#tanggal_mobile').length) {
                        const tanggalPicker = flatpickr("#tanggal_mobile", {
                            ...
                            minDate: "<?php echo e(date('Y-m-d')); ?>", // Tidak bisa pilih tanggal sebelum hari ini
                ...
                function updateUnitJob(selectElement) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('prepress.job-order.get-unit-job')); ?>",
                        type: "POST",
                        data: {
                ...
                var submitJobPrepress = "<?php echo e(route('prepress.job-order.submit-new')); ?>";
                ...
                $('#submitJobPrepress').submit(function(e) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('prepress.job-order.check-limit-time')); ?>",
                        type: "POST",
                        data: {
                ...
                function checkJobOrderLimit(deadlineDate) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('prepress.job-order.check-limit')); ?>",
                        type: "POST",
                        data: {
                            deadline_date: deadlineDate
                        },
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/process/prepress/input-job-order-prepress-new.blade.php ENDPATH**/ ?>