    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#datatable-materials').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route("hr.portal-training.master.materials.getData")); ?>',
                    type: 'GET'
                },
                columns: [
            ...
            $('#addForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("hr.portal-training.master.materials.store")); ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '.btn-view', function() {
                var id = $(this).data('id');
                $.get(`<?php echo e(route('hr.portal-training.master.materials.show', ':id')); ?>`.replace(':id', id), function(data) {
            ...
            $('#editForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `<?php echo e(route('hr.portal-training.master.materials.update', ':id')); ?>`.replace(':id', id),
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(route('hr.portal-training.master.materials.destroy', ':id')); ?>`.replace(':id', id),
                            type: 'DELETE',
                            success: function(response) {
                                Swal.fire({
                                    icon: 'success',
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/portal-training/master/materials/index.blade.php ENDPATH**/ ?>