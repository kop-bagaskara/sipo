        ...
        <script>
            $(document).ready(function() {
                ...
                var datatable = $('#datatable-job-order-prepress-for-plan').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(route('prepress.job-order-plan.data')); ?>",
                        type: "POST",
                        data: function(d) {
                ...
                $(document).on('click', '#submit-plan-prepress', function() {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('prepress.job-order.submit-plan')); ?>",
                        type: "POST",
                        data: {
                ...
                $(document).on('click', '#export-plan-prepress', function() {
                    ...
                    let form = $('<form>', {
                        'method': 'POST',
                        'action': "<?php echo e(route('prepress.job-order.export-plan')); ?>"
                    });
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/process/prepress/data/data-planharian.blade.php ENDPATH**/ ?>