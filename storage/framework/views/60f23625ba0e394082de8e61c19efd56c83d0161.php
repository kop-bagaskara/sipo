<aside class="left-sidebar">
    <div class="scroll-sidebar">
        <nav class="sidebar-nav">
            ...
            <li>
                <a class="waves-effect waves-dark" href="<?php echo e(route('ebook-pkb.index')); ?>"
                    aria-expanded="false">
            ...
            <li>
                ...
                <ul aria-expanded="false" class="collapse">
                    <li>
                        <a href="<?php echo e(route('label-management.index')); ?>" aria-expanded="false">
                            Label
                            Management</a>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo e(route('forecasting.index')); ?>" aria-expanded="false">
                            Forecasting</a>
                    </li>
                    ...
                    <li><a href="<?php echo e(route('hr.approval-settings.index')); ?>">Master Setting
                            Approval</a></li>
                    <li><a href="<?php echo e(route('hr.approval-settings.divisions.index')); ?>">Setting
                            Approval Per Divisi</a></li>
                    <li><a href="<?php echo e(route('hr.absence-settings.index')); ?>">Master Setting
                            Absence</a></li>
                    <?php endif; ?>
            ...
            <li>
                ...
                <ul aria-expanded="false" class="collapse">
                    <li>
                        <a href="<?php echo e(route('hr.portal-training.master.dashboard.index')); ?>"
                            aria-expanded="false">
                            <i class="mdi mdi-view-dashboard mr-2"></i>Dashboard
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('hr.portal-training.index')); ?>" aria-expanded="false">
                            <i class="mdi mdi-play-circle mr-2"></i>Training Saya
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('hr.portal-training.scores.index')); ?>"
                            aria-expanded="false">
            ...
            <li>
                ...
                <ul aria-expanded="false" class="collapse">
                    ...
                    <li><a href="<?php echo e(route('master.menu-navigation-settings.index')); ?>">Menu Navigation Settings</a></li>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/layouts/topbar-nav.blade.php ENDPATH**/ ?>