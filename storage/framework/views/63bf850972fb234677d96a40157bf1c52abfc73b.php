                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="<?php echo e(route('hr.training.schedule.create')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="card-body">
                        <!-- Filter Form -->
                        <form method="GET" action="<?php echo e(route('hr.training.schedule.index')); ?>" class="mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option value="scheduled"
                                                <?php echo e(request('status') == 'scheduled' ? 'selected' : ''); ?>>Terjadwal</option>
                                            <option value="ongoing" <?php echo e(request('status') == 'ongoing' ? 'selected' : ''); ?>>
                                                Berlangsung</option>
                                            <option value="completed"
                                                <?php echo e(request('status') == 'completed' ? 'selected' : ''); ?>>Selesai</option>
                                            <option value="cancelled"
                                                <?php echo e(request('status') == 'cancelled' ? 'selected' : ''); ?>>Dibatalkan
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <a href="<?php echo e(route('hr.training.schedule.index')); ?>" class="btn btn-secondary">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <strong><?php echo e($schedule->training->training_name); ?></strong>
                                                <br>
                                                <small class="text-muted"><?php echo e($schedule->training->training_code); ?></small>
                                            </td>
                                            <td><?php echo e($schedule->formatted_date); ?></td>
                                            <td>
                                            ...
                                            <td><?php echo e($schedule->creator->name ?? 'N/A'); ?></td>
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="<?php echo e(route('hr.training.schedule.show', $schedule->id)); ?>"
                                                        class="btn btn-sm btn-info" title="Lihat Detail">
                                                        <i class="mdi mdi-eye"></i>
                                                    </a>
                                                    <a href="<?php echo e(route('hr.training.schedule.edit', $schedule->id)); ?>"
                                                        class="btn btn-sm btn-warning" title="Edit">
                                                        <i class="mdi mdi-pencil"></i>
                                                    </a>
                                                    <?php if($schedule->status !== 'ongoing'): ?>
                                                        <button type="button" class="btn btn-sm btn-danger"
                                                            onclick="deleteSchedule(<?php echo e($schedule->id); ?>)" title="Hapus">
        ...
        <?php $__env->startSection('scripts'); ?>
            <script>
                function deleteSchedule(id) {
                    $('#deleteForm').attr('action', '<?php echo e(route('hr.training.schedule.destroy', ':id')); ?>'.replace(':id', id));
                    $('#deleteModal').modal('show');
                }
            </script>
        <?php $__env->stopSection(); ?>

<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/training/schedule/index.blade.php ENDPATH**/ ?>