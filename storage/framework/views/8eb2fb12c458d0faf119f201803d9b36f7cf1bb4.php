            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="hidden" name="role" id="role" value="<?php echo e(Auth::user()->jabatan); ?>">
                        <input type="hidden" name="nama_pelapor" id="nama_pelapor" value="<?php echo e($jobOrder->created_by); ?>">
                        <input type="hidden" name="nama_userlogin" id="nama_userlogin" value="<?php echo e(Auth::user()->name); ?>">
                        <input type="hidden" name="flag_two_shift" id="flag_two_shift" value="<?php echo e($jobOrder->two_shift); ?>">

                        <h5>Job : <?php echo e($jobOrder->job_title); ?></h5>
                        <p class="card-subtitle mb-4">Issued by : <?php echo e($jobOrder->created_by); ?></p>
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" name="tanggal" class="form-control" required
                                                    value="<?php echo e(date('Y-m-d', strtotime($jobOrder->tanggal_job_order))); ?>" readonly>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="job_deadline">Job Deadline</label>
                                                <input type="date" name="job_deadline" class="form-control" required
                                                    value="<?php echo e(date('Y-m-d', strtotime($jobOrder->tanggal_deadline))); ?>" readonly>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table class="table table-bordered mb-2">
                                                            ...
                                                            <table class="table table-bordered mb-2"
                                                                ...
                                                                <?php for($i = 1; $i <= 5; $i++): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td style="width:40%">
                                                                            <input type="text"
                                                                                name="color[<?php echo e($i); ?>]"
                                                                                id="color<?php echo e($i); ?>"
                                                                                class="form-control"
                                                                        ...
                                                                        <td style="width:40%">
                                                                            <input type="text"
                                                                                name="color[<?php echo e($i + 5); ?>]"
                                                                                id="color<?php echo e($i + 5); ?>"
                                                                                class="form-control"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="qty_order_estimation"
                                                                ...
                                                                value="<?php echo e($jobOrder->qty_order_estimation); ?>" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="text" name="job_order" class="form-control"
                                                                value="<?php echo e($jobOrderValue); ?>" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <table class="table table-bordered mb-2"
                                                                ...
                                                                <tr>
                                                                    <td style="width:10%">
                                                                        <input type="checkbox" name="file_data[]"
                                                                            value="Contoh Cetak"
                                                                            <?php echo e(in_array('Contoh Cetak', $fileDataList ?? []) ? 'checked' : 'disabled'); ?>
                                                                    ...
                                                                    <td style="width:10%">
                                                                        <input type="checkbox" name="file_data[]"
                                                                            value="Contoh Produk"
                                                                            <?php echo e(in_array('Contoh Produk', $fileDataList ?? []) ? 'checked' : 'disabled'); ?>
                                                                ...
                                                                <tr>
                                                                    <td style="width:10%">
                                                                        <input type="checkbox" name="file_data[]"
                                                                            value="File Softcopy"
                                                                            <?php echo e(in_array('File Softcopy', $fileDataList ?? []) ? 'checked' : 'disabled'); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="prioritas_job"
                                                                class="form-control" required
                                                                value="<?php echo e($jobOrder->prioritas_job); ?>" readonly></td>
                                                    <tr>
                                                        <td style="width:5%"><b>10. </b></td>
                                                        <td style="width:20%"><b>Catatan</b></td>
                                                        <td>
                                                            <input type="text" name="catatan" class="form-control"
                                                                required value="<?php echo e($jobOrder->catatan); ?>" readonly>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <div class="row">
                                                    <div class="col" style="text-align: center;">
                                                        ...
                                                        <br>
                                                        <span><?php echo e($jobOrder->created_at); ?></span>
                                                    </div>
                                                    <div class="col" style="text-align: center;">
                                                        ...
                                                        <br>
                                                        <span><?php echo e($jobOrder->received_at); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" name="id_job_order" id="id_job_order"
                                                    class="form-control" value="<?php echo e($jobOrder->id); ?>" hidden>
                                                ...
                                                <input type="text" name="status_job" id="status_job"
                                                    class="form-control" value="<?php echo e($status_job); ?>" hidden>
                                            </div>

                                            <div class="col d-flex justify-content-end">
                                                <h5>Status : &nbsp;</h5>
                                                <?php if($jobOrder->status_job == 'OPEN'): ?>
                                                    <h5 class="text-primary">OPEN</h5>
                                                <?php elseif($jobOrder->status_job == 'PLAN'): ?>
                                                    <h5 class="text-info">PLAN</h5>
                                                <?php elseif($jobOrder->status_job == 'ASSIGNED'): ?>
                                                    <h5 class="text-warning">ASSIGNED</h5>
                                                <?php elseif($jobOrder->status_job == 'IN PROGRESS'): ?>
                                                    <h5 class="text-success">IN PROGRESS</h5>
                                                <?php elseif($jobOrder->status_job == 'APPROVED'): ?>
                                                    <h5 class="text-info">APPROVED</h5>
                                                <?php elseif($jobOrder->status_job == 'REJECTED'): ?>
                                                    <h5 class="text-danger">REJECTED</h5>
                                                <?php elseif($jobOrder->status_job == 'COMPLETED'): ?>
                                                    <h5 class="text-success">COMPLETED</h5>
                                                <?php elseif($jobOrder->status_job == 'ASSIGN'): ?>
                                                    <h5 class="text-warning">ASSIGN</h5>
                                                <?php elseif($jobOrder->status_job == 'DATA TERISI'): ?>
                                                    <h5 class="text-info">DATA TERISI</h5>
                                                <?php elseif($jobOrder->status_job == 'FINISH'): ?>
                                                    <h5 class="text-success">FINISH</h5>
                                                <?php elseif($jobOrder->status_job == 'SHIFT_2'): ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <p>: <?php echo e($jobOrder->job_order); ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="tanggal" class="col-sm-2">Sub Unit</label>
                                            <div class="col-sm-10">
                                                <p>: <?php echo e($jobOrder->sub_unit_job); ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="tanggal" class="col-sm-2">Item</label>
                                            <div class="col-sm-10">
                                                <p>: <?php echo e($jobOrder->kode_design . ' - ' . $jobOrder->product); ?></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="tanggal" class="col-sm-2">Estimasi Job</label>
                                            <div class="col-sm-4">
                                                <p>: <?php echo e($jobOrder->est_job_default); ?> Menit</p>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <?php if($jobOrder->two_shift == '1'): ?>
                                                    
                                                    <?php if(isset($inProgress1) && isset($user1)): ?>
                                                        <p>: <?php echo e($inProgress1); ?>, Oleh: <?php echo e($user1); ?> <span style="color: blue;">(SHIFT 1)</span></p>
                                                    <?php endif; ?>

                                                    
                                                    <?php if(isset($inProgress2) && isset($user2)): ?>
                                                        <p>: <?php echo e($inProgress2); ?>, Oleh: <?php echo e($user2); ?> <span style="color: blue;">(SHIFT 2)</span></p>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    
                                                    <p>: <?php echo e($inProgress->date_handling ?? ''); ?>, Oleh:
                                                        <?php echo e($inProgress->name_user_handle ?? ''); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <?php if($jobOrder->two_shift == '1'): ?>
                                                    ...
                                                    <?php if(isset($finish1) && isset($user1)): ?>
                                                        <p>: <?php echo e($finish1); ?>, Oleh: <?php echo e($user1); ?> <span style="color: blue;">(SHIFT 1)</span></p>
                                                    <?php endif; ?>

                                                    
                                                    <?php if(isset($finish2) && isset($user2)): ?>
                                                        <p>: <?php echo e($finish2); ?>, Oleh: <?php echo e($user2); ?> <span style="color: blue;">(SHIFT 2)</span></p>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    
                                                    <p>: <?php echo e($finish->date_handling ?? ''); ?>, Oleh: <?php echo e($finish->name_user_handle ?? ''); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <p>: <?php echo e($approved->date_handling ?? ''); ?> , Oleh :
                                                    <?php echo e($approved->name_user_handle ?? ''); ?> </p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="tanggal" class="col-sm-2 ">Closed</label>
                                            <div class="col">
                                                <p>: <?php echo e($closed->date_handling ?? ''); ?> , Oleh :
                                                    <?php echo e($closed->name_user_handle ?? ''); ?> </p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="tanggal" class="col-sm-2 ">Paused</label>
                                            <div class="col">
                                                <p>: <?php echo e($pending->date_handling ?? ''); ?> , Oleh :
                                                    <?php echo e($pending->name_user_handle ?? ''); ?> , Alasan :
                                                    <?php echo e($pending->reason ?? ''); ?> </p>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <p>: <?php echo e($days); ?> Hari, <?php echo e($hours); ?> Jam,
                                                    <?php echo e($minutes); ?> Menit</p>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="attachment-list">
                                                            <?php if($jobOrder->attachmentJobOrder && $jobOrder->attachmentJobOrder->count() > 0): ?>
                                                                <?php $__currentLoopData = $jobOrder->attachmentJobOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <div class="d-flex align-items-center justify-content-between mb-2 p-2 border rounded">
                                                                        <div class="d-flex align-items-center">
                                                                            <i class="mdi mdi-file-document-outline mr-2" style="font-size: 20px; color: #4299e1;"></i>
                                                                            <span class="font-weight-medium"><?php echo e($item->file_name); ?></span>
                                                                            <?php if($item->file_type): ?>
                                                                                <span class="badge badge-secondary ml-2"><?php echo e(strtoupper($item->file_type)); ?></span>
                                                                            <?php endif; ?>
                                                                            <?php
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <a href="<?php echo e(asset('sipo_krisan/public/' . $item->file_path)); ?>"
                                                                                class="btn btn-primary btn-sm mr-1"
                                                                                title="View"
                                                                                target="_blank">
                                                                                <i class="mdi mdi-eye"></i> View
                                                                            ...
                                                                            <?php if(Auth::user()->jabatan == '3' || Auth::user()->jabatan == '4' || $jobOrder->created_by == Auth::user()->name): ?>
                                                                                <form action="<?php echo e(route('prepress.job-order.delete-attachment', $item->id)); ?>" method="POST" class="d-inline">
                                                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" class="form-control" id="waktu_setup_value_shift_1"
                                                        ...
                                                        value="<?php echo e($est_job_setup[0]); ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" class="form-control" id="waktu_downtime_value_shift_1"
                                                        ...
                                                        value="<?php echo e($est_job_downtime[0]); ?>" disabled>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" class="form-control" id="catatan_value_shift_1"
                                                        name="catatan_value_shift_1" value="<?php echo e($catatan_job[0]); ?>"
                                            ...
                                            <div class="col">
                                                <?php if($jobOrder->two_shift == '1'): ?>
                                                    <input type="text" class="form-control" id="waktu_downtime_value_shift_2"
                                                        ...
                                                        value="<?php echo e($est_job_downtime[1] ?? ''); ?>" disabled>
                                                <?php else: ?>
                                                    ...
                                                    value="<?php echo e($jobOrder->est_job_downtime); ?>" disabled>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col">
                                                <?php if($jobOrder->two_shift == '1'): ?>
                                                    ...
                                                    <input type="text" class="form-control" id="catatan_value_shift_2"
                                                        name="catatan_value_shift_2" value="<?php echo e($catatan_job[1] ?? ''); ?>" placeholder="Catatan">
                                                <?php else: ?>
                                                    <input type="text" class="form-control" id="catatan_value"
                                                        name="catatan_value" value="<?php echo e($jobOrder->catatan_job); ?>"
                                                        placeholder="Catatan">
                                                <?php endif; ?>
                                            </div>
                                        </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('body').on('click', '#submit-edit-progress-data', function() {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('progress-data-prepress.submit')); ?>',
                        type: "POST",
                        headers: {
                ...
                $('#submit-resume-data').click(function() {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('progress-data-prepress.resume')); ?>',
                        type: "POST",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                ...
                $('#submit-finish-data').click(function() {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('progress-data-prepress.finish')); ?>',
                        type: "POST",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/process/prepress/detail-job-order-assign-prepress.blade.php ENDPATH**/ ?>