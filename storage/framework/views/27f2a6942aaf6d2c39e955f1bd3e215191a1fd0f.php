...
<?php $__env->startSection('content'); ?>
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">HEAD DIVISI Pending Approval</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">HR</a></li>
                <li class="breadcrumb-item active">HEAD DIVISI Pending Approval</li>
            </ol>
        </div>
    </div>

    <?php
        $totalPending = $formRequests->count() + $overtimeRequests->count() + ($splRequests->count() ?? 0) + $vehicleRequests->count() + $assetRequests->count();
        $dataLemburCount = $overtimeRequests->count() + ($splRequests->count() ?? 0);
    ?>
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card"><div class="card-body text-center"><h3 class="text-warning"><?php echo e($totalPending); ?></h3><p class="text-muted mb-0">Total Menunggu</p></div></div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="card"><div class="card-body text-center"><h3 class="text-warning"><?php echo e($dataLemburCount); ?></h3><p class="text-muted mb-0">Data Lembur</p></div></div>
        </div>
        <div class="col-md-3">
            <div class="card"><div class="card-body text-center"><h3 class="text-success"><?php echo e($vehicleRequests->count() + $assetRequests->count()); ?></h3><p class="text-muted mb-0">Kendaraan & Inventaris</p></div></div>
        </div>
    </div>

    <div class="row"><div class="col-12"><div class="card"><div class="card-header"><h4 class="card-title">Daftar Pengajuan Menunggu Approval HEAD DIVISI</h4></div><div class="card-body">
        <ul class="nav nav-tabs mb-4" id="requestTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation"><button class="nav-link" id="overtime-tab" data-toggle="tab" data-target="#overtime" type="button" role="tab"><i class="mdi mdi-clock me-1"></i> Data Lembur <span class="badge badge-warning"><?php echo e($dataLemburCount); ?></span></button></li>
            ...
            <li class="nav-item" role="presentation"><button class="nav-link" id="asset-tab" data-toggle="tab" data-target="#asset" type="button" role="tab"><i class="mdi mdi-package-variant me-1"></i> Inventaris <span class="badge badge-info"><?php echo e($assetRequests->count()); ?></span></button></li>
        </ul>

        <div class="tab-content" id="requestTabsContent">
            <div class="tab-pane fade show active" id="forms" role="tabpanel">
                <?php if($formRequests->count() > 0): ?>
                    <div class="table-responsive"><table class="table table-hover"><thead><tr><th>No. Pengajuan</th><th>Jenis</th><th>Pemohon</th><th>Status Approval</th><th>Tanggal Dibuat</th><th>Aksi</th></tr></thead><tbody>
                    <?php $__currentLoopData = $formRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo $request->current_approval_status_text; ?></td>
            ...
            <div class="tab-pane fade" id="overtime" role="tabpanel">
                <?php if($dataLemburCount > 0): ?>
                    <div class="table-responsive"><table class="table table-hover"><thead><tr><th>No. Dokumen</th><th>Tanggal</th><th>Shift</th><th>Divisi</th><th>Supervisor</th><th>Jml Karyawan</th><th>Keperluan</th><th>Status</th><th>Aksi</th></tr></thead><tbody>
                    <?php $__currentLoopData = $splRequests ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><span class="badge bg-secondary text-white"><?php echo e($spl->shift); ?></span></td>
                ...
                <?php else: ?>
                    <div class="text-center py-5"><i class="mdi mdi-check-circle text-success" style="font-size: 4rem;"></i><h5 class="text-muted mt-3">Tidak ada data lembur yang menunggu approval</h5></div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/approval/head-pending.blade.php ENDPATH**/ ?>