...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row"><div class="col-12"><div class="card"><div class="card-header"><h4 class="card-title">Daftar Pengajuan Menunggu Approval Manager</h4></div><div class="card-body">
        ...
        <div class="tab-content" id="requestTabsContent">
            <div class="tab-pane fade show active" id="forms" role="tabpanel">
                <?php if($formRequests->count() > 0): ?>
                    <div class="table-responsive"><table class="table table-hover"><thead><tr><th>No. Pengajuan</th><th>Jenis</th><th>Pemohon</th><th>Tanggal Dibuat</th><th>Aksi</th></tr></thead><tbody>
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/approval/manager-pending.blade.php ENDPATH**/ ?>