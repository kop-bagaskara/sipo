<?php $__env->startSection('title', 'Master Setting Absence'); ?>
    ...
    <script>
        $(document).ready(function() {
            const table = $('#absenceSettingsTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('hr.absence-settings.index')); ?>',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $('#saveBtn').click(function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('hr.absence-settings.store')); ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $('#updateBtn').click(function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('hr.absence-settings.update', '')); ?>/' + id,
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(route('hr.absence-settings.destroy', '')); ?>/' + id,
                            type: 'DELETE',
                            headers: {
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                            },
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/absence-settings/index.blade.php ENDPATH**/ ?>