                    ...
                    <div class="accordion" id="levelAccordion">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseStaff" class="collapse show" aria-labelledby="headingStaff" data-parent="#levelAccordion">
                                <div class="card-body">
                                    <?php echo $__env->make('hr.applicants.partials.applicant-table', [
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        window.confirmDelete = function(id, level) {
            ...
            let deleteUrl;
            if (level === 'staff') {
                deleteUrl = '<?php echo e(url("sipo/hr/applicants")); ?>/' + id;
            } else {
                deleteUrl = '<?php echo e(url("sipo/hr/staff-applicants")); ?>/' + id;
            }
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/applicants/index.blade.php ENDPATH**/ ?>