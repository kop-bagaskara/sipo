    ...
    <?php $__env->startSection('content'); ?>
        ...
        <div class="row">
            <div class="col-md-3">
                            ...
                            <a href="#"
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    <span class="badge text-info"
                                        style="font-size: 29px; margin-bottom: 10px;"><?php echo e($stats['total_requests']); ?></span>
                            ...
                            <a href="#"
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    <span class="badge text-warning"
                                        style="font-size: 29px; margin-bottom: 10px;"><?php echo e($stats['approved_requests']); ?></span>
                            ...
                            <a href="#"
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    <span class="badge text-danger"
                                        style="font-size: 29px; margin-bottom: 10px;"><?php echo e($stats['rejected_requests']); ?></span>
                ...
                <?php if(Auth::user()->jabatan == 5 ||
                        Auth::user()->jabatan == 4 ||
                        Auth::user()->jabatan == 3 ||
                        (method_exists(Auth::user(), 'isHR') && Auth::user()->isHR())): ?>
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php if(Auth::user()->jabatan == 5): ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo e(route('hr.approval.supervisor-pending')); ?>"
                                                            class="text-info">
                                                            SPV Pending</a></td>
                                                    <td class="text-right"><span id="spvPendingCount"
                                                            class="label label-light-info"><?php echo e($stats['spv_pending'] ?? 0); ?></span>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                            ...
                                            <?php if(Auth::user()->jabatan == 4): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e(route('hr.approval.head-pending')); ?>"
                                                            class="text-info">
                                                            Head Pending
                                                        </a>
                                                        <?php if(Auth::user()->divisi == 4): ?>
                                                            <br><small class="text-muted">(Produksi + Prepress)</small>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td class="text-right"><span id="headPendingCount"
                                                            class="label label-light-info"><?php echo e($stats['head_pending'] ?? 0); ?></span>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>

                                            <?php if(Auth::user()->jabatan == 3 && Auth::user()->divisi != 13): ?>
                                                <tr>
                                                    <td style="width:40px"><i class="mdi mdi-account text-warning"></i></td>
                                                    <td><a href="<?php echo e(route('hr.approval.manager-pending')); ?>"
                                                            class="text-warning">
                                                            Manager Pending</a></td>
                                                    <td class="text-right"><span id="managerPendingCount"
                                                            class="label label-light-warning"><?php echo e($stats['manager_pending'] ?? 0); ?></span>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>

                                            <?php if(Auth::user()->divisi == 13): ?>
                                                <tr>
                                                    <td style="width:40px"><i class="mdi mdi-account-star text-primary"></i>
                                                    </td>
                                                    <td><a href="<?php echo e(route('hr.approval.general-manager-pending')); ?>"
                                                            class="text-primary">
                                                            General Manager Pending</a></td>
                                                    <td class="text-right"><span id="generalManagerPendingCount"
                                                            class="label label-light-primary"><?php echo e($stats['general_manager_pending'] ?? 0); ?></span>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>

                                            <?php if(method_exists(Auth::user(), 'isHR') && Auth::user()->isHR()): ?>
                                                <tr>
                                                    <td style="width:40px"><i class="mdi mdi-account text-success"></i>
                                                    </td>
                                                    <td><a href="<?php echo e(route('hr.approval.hr-pending')); ?>"
                                                            class="text-success">HRD
                                                            Pending</a></td>
                                                    <td class="text-right"><span id="hrPendingCount"
                                                            class="label label-light-success"><?php echo e($stats['hr_pending'] ?? 0); ?></span>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="month" class="form-control" id="chartMonth" value="<?php echo e(date('Y-m')); ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('hr.requests.guide')); ?>" class="btn btn-sm btn-outline-primary"
                                target="_blank">
                                <i class="mdi mdi-book-open-page-variant me-1"></i>Tata Cara Penggunaan
                            </a>
                            <a href="<?php echo e(route('hr.requests.index')); ?>" class="btn btn-sm btn-outline-info">
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card border-left-primary">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="<?php echo e(route('hr.requests.create', ['type' => 'shift_change'])); ?>"
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card border-left-info">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="<?php echo e(route('hr.requests.create', ['type' => 'absence'])); ?>"
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card border-left-warning">
                                    <div class="card-body text-center">
                                        ...
                                        <a href="<?php echo e(route('hr.spl.create')); ?>"
                                ...
                                <div class="card border-left-danger">
                                    <div class="card-body text-center">
                                        ...
                                        <div class="btn-group w-100" role="group">
                                            <a href="<?php echo e(route('hr.vehicle-asset.create', ['type' => 'vehicle'])); ?>"
                                            ...
                                            <ul class="dropdown-menu w-100">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('hr.vehicle-asset.create', ['type' => 'vehicle'])); ?>">
                                                        <i class="mdi mdi-car me-2"></i>KENDARAAN
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('hr.vehicle-asset.create', ['type' => 'asset'])); ?>">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="<?php echo e(route('hr.requests.report')); ?>" class="btn btn-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content" id="requestTabsContent">
                                            ...
                                            <div class="tab-pane fade show active" id="requests" role="tabpanel">
                                                <!-- Filter Section -->
                                                <form method="GET" action="<?php echo e(route('hr.requests.index')); ?>"
                                                    id="filterForm">
                                                    <div class="mb-4">
                                                        <div class="row">
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <select class="form-control" id="requestFilter"
                                                                    ...
                                                                    <option value="forms"
                                                                        <?php echo e(request('filter_type') == 'forms' ? 'selected' : ''); ?>>
                                                                        Form Karyawan</option>
                                                                    <option value="overtime"
                                                                        <?php echo e(request('filter_type') == 'overtime' ? 'selected' : ''); ?>>
                                                                        Data Lembur</option>
                                                                    <option value="vehicle"
                                                                        <?php echo e(request('filter_type') == 'vehicle' ? 'selected' : ''); ?>>
                                                                        Kendaraan</option>
                                                                    <option value="asset"
                                                                        <?php echo e(request('filter_type') == 'asset' ? 'selected' : ''); ?>>
                                                                        Inventaris</option>
                                                                    <option value="spl"
                                                                        <?php echo e(request('filter_type') == 'spl' ? 'selected' : ''); ?>>
                                                                        Surat Lembur</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                ...
                                                                <input type="date" class="form-control" id="dateTo"
                                                                    name="date_to" value="<?php echo e(request('date_to')); ?>">
                                                            </div>
                                                ...
                                                <div id="noFilterMessage" class="text-center py-5"
                                                    style="display: <?php echo e(empty($filterType) ? 'block' : 'none'); ?>;">
                                                ...
                                                <div id="filter-forms" class="filter-section"
                                                    style="display: <?php echo e($filterType == 'forms' ? 'block' : 'none'); ?>;">
                                                                ...
                                                                <tbody>
                                                                    <?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            <td>
                                                                                <span
                                                                                    class="fw-bold text-primary"><?php echo e($request->request_number); ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="badge bg-info"
                                                                                    style="color: white;"><?php echo e($request->request_type_label); ?></span>
                                                                            </td>
                                                                            <td><?php echo e($request->employee->name ?? 'N/A'); ?>

                                                                            </td>
                                                                            <td>
                                                                                <span
                                                                                    class="badge <?php echo e($request->status_badge_class); ?>"><?php echo e($request->status_label); ?></span>
                                                                            </td>
                                                                            <td><?php echo e($request->created_at->format('d/m/Y H:i')); ?>

                                                                            </td>
                                                                            <td>
                                                                                <span
                                                                                    class="text-muted"><?php echo e($request->days_since_created); ?>

                                                                                    hari</span>
                                                                            </td>
                                                                            <td>
                                                                                <div class="btn-group" role="group">
                                                                                    <a href="<?php echo e(route('hr.requests.show', $request->id)); ?>"
                                                                                        class="btn btn-sm btn-outline-primary"
                                                                                        title="Lihat Detail">
                                                                                        <i class="mdi mdi-eye"></i>
                                                                                    </a>
                                                                                    <?php if($request->employee_id == auth()->id() && $request->status == 'pending'): ?>
                                                                                        <a href="<?php echo e(route('hr.requests.edit', $request->id)); ?>"
                                                                                            class="btn btn-sm btn-outline-warning"
                                                                                            title="Edit">
                                                                                            <i class="mdi mdi-pencil"></i>
                                                                                        </a>
                                                                                        <form method="POST"
                                                                                            action="<?php echo e(route('hr.requests.cancel', $request->id)); ?>"
                                                                                            class="d-inline"
                                                    ...
                                                    <?php else: ?>
                                                        <div class="text-center py-5">
                                                            ...
                                                            <p class="text-muted">Belum ada pengajuan form karyawan (cuti,
                                                                shift change, dll).</p>
                                                            <a href="<?php echo e(route('hr.requests.create')); ?>"
                                                ...
                                                <div id="filter-overtime" class="filter-section"
                                                    style="display: <?php echo e($filterType == 'overtime' ? 'block' : 'none'); ?>;">
                                                    <?php if($overtimeEntries->count() > 0): ?>
                                                        <div class="table-responsive">
                                                            <table id="overtimeTable"
                                                                ...
                                                                <tbody>
                                                                    <?php $__currentLoopData = $overtimeEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            <td><?php echo e($entry->request_date->format('d/m/Y')); ?>

                                                                            </td>
                                                                            <td><?php echo e($entry->employee_name); ?></td>
                                                                            <td><?php echo e(\Illuminate\Support\Str::limit($entry->location, 30)); ?>

                                                                            </td>
                                                                            <td><?php echo e($entry->start_time->format('H:i')); ?>-<?php echo e($entry->end_time->format('H:i')); ?>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                ?>
                                                                                <span
                                                                                    class="badge badge-<?php echo e($status['class']); ?> text-white"><?php echo e($status['text']); ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <a href="<?php echo e(route('hr.overtime.index')); ?>"
                                                                                    class="btn btn-sm btn-outline-warning">
                                                                                    <i class="mdi mdi-eye"></i>
                                                                                </a>
                                                                            </td>
                                                ...
                                                <div id="filter-vehicle" class="filter-section"
                                                    style="display: <?php echo e($filterType == 'vehicle' ? 'block' : 'none'); ?>;">
                                                            ...
                                                            <table id="vehicleTable"
                                                                ...
                                                                <tbody>
                                                                    <?php $__currentLoopData = $vehicleRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            <td><?php echo e($request->request_date->format('d/m/Y')); ?>
                                                ...
                                                <div id="filter-asset" class="filter-section"
                                                    style="display: <?php echo e($filterType == 'asset' ? 'block' : 'none'); ?>;">
                                                                    ...
                                                                    <?php $__currentLoopData = $assetRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                ?>
                                                                                <span
                                                                                    class="badge badge-<?php echo e($status['class']); ?>"
                                                                                    style="color: white;"><?php echo e($status['text']); ?></span>
                                                                            </td>
                                                                            <td>
                                                ...
                                                <div id="filter-spl" class="filter-section"
                                                    style="display: <?php echo e($filterType == 'spl' ? 'block' : 'none'); ?>;">
                                                    <?php if(isset($splRequests) && $splRequests->count() > 0): ?>
                                                        <div class="table-responsive">
                                                            <table id="splTable"
                                                                class="table table-striped table-bordered dt-responsive nowrap"
                                                                style="width:100%">
                                                                ...
                                                                <tbody>
                                                                    <?php $__currentLoopData = $splRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            <td>
                                                                                <span
                                                                                    class="fw-bold text-warning"><?php echo e($spl->spl_number); ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <?php echo e($spl->request_date->format('d/m/Y')); ?>

                                                                            </td>
                                                                            <td><?php echo e($spl->shift); ?></td>
                                                                            <td><?php echo e($spl->supervisor->name ?? '-'); ?></td>
                                                                            <td style="text-align: center;">
                                                                                <span
                                                                                    class="badge bg-info"><?php echo e($spl->employees->count()); ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <?php
                                                                                    $statusMap = [
                                                                            ...
                                                                            <td>
                                                                                <a href="<?php echo e(route('hr.spl.show', $spl->id)); ?>"
                                                                                    class="btn btn-sm btn-outline-warning">
                                                                                    <i class="mdi mdi-eye"></i>
                                                                                </a>
                                                                            </td>
    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        <script>
            ...
            (function loadApprovalStats() {
                silentFetch('<?php echo e(route('hr.approval.stats')); ?>')
                    .then(stats => {
                        if (!stats) return; // Skip jika fetch gagal

                        // For approver (HEAD/SPV), controller returns pending_approval
            ...
            function initializeCalendar() {
                ...
                window.calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    events: function(info, successCallback, failureCallback) {
                        ...
                        silentFetch('<?php echo e(route('hr.requests.calendar-events')); ?>')
                            .then(data => {
                                if (!data) {
            ...
            function showEventDetails(event) {
                ...
                silentFetch(
                        `<?php echo e(route('hr.requests.calendar-request-details')); ?>?date=${date}&type=${type}&request_ids=${requestIds.join(',')}`
                        )
                    .then(result => {
                        ...
                        result.data.forEach((item, index) => {
                            const statusBadgeClass = item.status === 'pending' ? 'warning' :
                                item.status === 'hr_approved' || item.status === 'supervisor_approved' ? 'success' :
                                item.status === 'hr_rejected' || item.status === 'supervisor_rejected' ? 'danger' :
                                'info';
                            ...
                            tableRows += `
                                <tr>
                                    ...
                                    <td>${item.employee_divisi || '-'}</td>
                                    <td><span class="badge badge-${statusBadgeClass}">${item.status_label || item.status || '-'}</span></td>
                                    <td>${item.notes || '-'}</td>
                                </tr>
                            `;
                        });
                        ...
                        const content = `
                            <div class="p-3">
                                <div class="text-center mb-3">
                                    <i class="mdi ${typeIcon} me-2" style="font-size: 2rem; color: #4a90e2;"></i>
                                    <h5 class="mt-2 mb-2">${typeLabel}</h5>
                                    <p class="mb-3"><strong>Tanggal:</strong> ${formattedDate}</p>
                                    <span class="badge badge-primary" style="font-size: 1.2rem; padding: 8px 16px;">
                                        Total: ${count} ${count == 1 ? 'permohonan' : 'permohonan'}
                                    </span>
                                </div>
            ...
            let formsTable, overtimeTable, vehicleTable, assetTable, splTable;
            ...
            function loadDepartmentAbsenceChart() {
                ...
                // Fetch data from API
                silentFetch(`<?php echo e(route('hr.requests.department-absence-stats')); ?>?department_id=${departmentId}&month=${month}`)
                    .then(result => {
                        btn.disabled = false;
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/dashboard-karyawan.blade.php ENDPATH**/ ?>