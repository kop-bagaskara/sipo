                                ...
                                <div class="form-group">
                                    ...
                                    <div class="employee-checkbox-container">
                                        <?php $__currentLoopData = $divisis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $divisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(isset($employeesByDivisi[$divisi->id]) && $employeesByDivisi[$divisi->id]->count() > 0): ?>
                                                <div class="divisi-group">
                                                    <div class="divisi-group-header">
                                                        <span><i class="mdi mdi-office-building"></i> <?php echo e($divisi->divisi); ?></span>
                                                        <span class="select-all-divisi" data-divisi="<?php echo e($divisi->id); ?>">Pilih Semua</span>
                                                    </div>
                                                    <?php $__currentLoopData = $employeesByDivisi[$divisi->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="employee-checkbox-item">
                                                            <input type="checkbox" 
                                                                   name="employee_ids[]" 
                                                                   id="bulk_employee_<?php echo e($emp->id); ?>" 
                                                                   value="<?php echo e($emp->id); ?>" 
                                                                   class="employee-checkbox bulk-employee-checkbox"
                                                                   data-employee-id="<?php echo e($emp->id); ?>"
                                                                   data-no-limit="true">
                                                            <label for="bulk_employee_<?php echo e($emp->id); ?>"><?php echo e($emp->name); ?></label>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="material-checkbox-container">
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(isset($materialsByCategory[$category->id]) && count($materialsByCategory[$category->id]['materials']) > 0): ?>
                                        <div class="category-group">
                                            <div class="category-group-header">
                                                <span><i class="mdi mdi-folder"></i> <?php echo e($category->category_name); ?></span>
                                                <span class="select-all-category" data-category="<?php echo e($category->id); ?>">Pilih Semua</span>
                                            </div>
                                            <?php $__currentLoopData = $materialsByCategory[$category->id]['materials']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="material-checkbox-item">
                                                    <input type="checkbox" name="material_ids[]" id="bulk_material_<?php echo e($mat->id); ?>" value="<?php echo e($mat->id); ?>" class="material-checkbox bulk-material-checkbox">
                                                    <label for="bulk_material_<?php echo e($mat->id); ?>"><?php echo e($mat->material_title); ?></label>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(count($materialsWithoutCategory) > 0): ?>
                                    <div class="category-group">
                                        <div class="category-group-header">
                                        ...
                                        <?php $__currentLoopData = $materialsWithoutCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="material-checkbox-item">
                                                <input type="checkbox" name="material_ids[]" id="bulk_material_<?php echo e($mat->id); ?>" value="<?php echo e($mat->id); ?>" class="material-checkbox bulk-material-checkbox">
                                                <label for="bulk_material_<?php echo e($mat->id); ?>"><?php echo e($mat->material_title); ?></label>
                                            </div>
                    ...
                    <div class="modal-body">
                                        ...
                                        <?php $__currentLoopData = $divisis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $divisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(isset($employeesByDivisi[$divisi->id]) && $employeesByDivisi[$divisi->id]->count() > 0): ?>
                                                <div class="divisi-group">
                                                    ...
                                                    <?php $__currentLoopData = $employeesByDivisi[$divisi->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="employee-checkbox-item">
                                                            <input type="radio" name="employee_id" id="edit_employee_<?php echo e($emp->id); ?>" value="<?php echo e($emp->id); ?>" class="employee-radio edit-employee-radio" required>
                                                            <label for="edit_employee_<?php echo e($emp->id); ?>"><?php echo e($emp->name); ?></label>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="material_ids[]" id="editMaterialIds" class="form-control" multiple required>
                                ...
                                <?php $__currentLoopData = $allMaterials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($mat->id); ?>"><?php echo e($mat->material_title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#datatable-assignments').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route("hr.portal-training.master.assignments.getData")); ?>',
                    type: 'GET'
                },
                columns: [
            ...
            $('#bulkForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '<?php echo e(route("hr.portal-training.master.assignments.bulkAssign")); ?>',
                    type: 'POST',
                    data: $(this).serialize(),
            ...
            $(document).on('click', '.btn-view', function() {
                var id = $(this).data('id');
                $.get(`<?php echo e(route('hr.portal-training.master.assignments.show', ':id')); ?>`.replace(':id', id), function(data) {
            ...
            $(document).on('click', '.btn-edit', function() {
                var id = $(this).data('id');
                $.get(`<?php echo e(route('hr.portal-training.master.assignments.edit', ':id')); ?>`.replace(':id', id), function(data) {
                    $('#editId').val(data.id);
            ...
            $('#editForm').on('submit', function(e) {
                ...
                var id = $('#editId').val();
                $.ajax({
                    url: `<?php echo e(route('hr.portal-training.master.assignments.update', ':id')); ?>`.replace(':id', id),
                    type: 'PUT',
                    data: $(this).serialize(),
                    success: function(response) {
                        Swal.fire({
            ...
            $(document).on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(route('hr.portal-training.master.assignments.destroy', ':id')); ?>`.replace(':id', id),
                            type: 'DELETE',
                            success: function(response) {
                                Swal.fire({
                                    icon: 'success',
            ...
            $(document).on('click', '.btn-view-session', function() {
                ...
                $.get(`<?php echo e(route('hr.portal-training.master.assignments.viewSession', ':code')); ?>`.replace(':code', sessionCode), function(data) {
            ...
            $(document).on('click', '.btn-delete-session', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(route('hr.portal-training.master.assignments.destroySession', ':code')); ?>`.replace(':code', sessionCode),
                            type: 'DELETE',
                            success: function(response) {
                                Swal.fire({
                                    icon: 'success',
            ...
            $(document).on('click', '.btn-start', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(route('hr.portal-training.master.assignments.start', ':id')); ?>`.replace(':id', id),
                            type: 'POST',
                            data: {
            ...
            $(document).on('click', '.btn-start-session', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `<?php echo e(route('hr.portal-training.master.assignments.startSession', ':code')); ?>`.replace(':code', sessionCode),
                            type: 'POST',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>'
                            },
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/portal-training/master/assignments/index.blade.php ENDPATH**/ ?>