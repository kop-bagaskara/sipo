    ...
    <?php $__env->startSection('content'); ?>
        ...
        <div class="row">
            <div class="col-md-3">
                            ...
                            <a href="#"
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    <span class="badge text-warning"
                                        style="font-size: 29px; margin-bottom: 10px;"><?php echo e($stats['pending_requests']); ?></span>
                ...
                <?php if(Auth::user()->jabatan == 5 || Auth::user()->jabatan == 4 || Auth::user()->jabatan == 3 || (method_exists(Auth::user(), 'isHR') && Auth::user()->isHR())): ?>
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('hr.requests.guide')); ?>" class="btn btn-sm btn-outline-primary" target="_blank">
                                            ...
                                            <div class="tab-pane fade" id="approval-history" role="tabpanel">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <?php if($approvalHistory->count() > 0): ?>
                                                            <div class="table-responsive">
                                                                <table class="table table-striped table-bordered" id="approvalHistoryTable">
                                                                    ...
                                                                    <tbody>
                                                                        <?php $__currentLoopData = $approvalHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            ?>
                                                                            <tr>
                                                                                <td><span class="fw-bold"><?php echo e($requestNumber); ?></span></td>
                                                                                <td>
                                                                                    <span class="badge bg-info text-white"><?php echo e($requestTypeLabel); ?></span>
                                                                                </td>
                                                                                <td><?php echo e($employeeName); ?></td>
                                                                                <td>
                                                                                    <span class="badge badge-secondary"><?php echo e($divisiName); ?></span>
                                                                                </td>
                                                                                <td>
                                                                                    <span class="badge badge-primary"><?php echo e($approvalRole); ?></span>
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td><?php echo e($approvalDate ? $approvalDate->format('d/m/Y H:i') : 'N/A'); ?></td>
                                                                                <td>
                                                                                    <?php if($approvalNotes): ?>
                                                                                        <span class="text-muted" title="<?php echo e($approvalNotes); ?>">
                                                                                            <?php echo e(\Illuminate\Support\Str::limit($approvalNotes, 50)); ?>
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/requests/index.blade.php ENDPATH**/ ?>