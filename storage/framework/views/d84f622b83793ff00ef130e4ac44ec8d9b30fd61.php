        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="GET" action="<?php echo e(route('security.goods-movement.index')); ?>" class="row g-3">
                            <div class="col-md-2">
                                <label class="form-label">Tanggal Dari</label>
                                <input type="date" class="form-control" name="tanggal_dari"
                                    value="<?php echo e(request('tanggal_dari', date('Y-m-d'))); ?>">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Tanggal Sampai</label>
                                <input type="date" class="form-control" name="tanggal_sampai"
                                    value="<?php echo e(request('tanggal_sampai', date('Y-m-d'))); ?>">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Nama Pengunjung</label>
                                <input type="text" class="form-control" name="nama_pengunjung"
                                    value="<?php echo e(request('nama_pengunjung')); ?>" placeholder="Cari nama...">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Perusahaan</label>
                                <input type="text" class="form-control" name="perusahaan_asal"
                                    value="<?php echo e(request('perusahaan_asal')); ?>" placeholder="Cari perusahaan...">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label">Lokasi</label>
                                <select class="form-select form-control" name="lokasi_filter">
                                    <option value="">Semua Lokasi</option>
                                    <option value="1" <?php echo e(request('lokasi_filter') == '1' ? 'selected' : ''); ?>>Lokasi 19 (KRISANTHIUM)</option>
                                    <option value="2" <?php echo e(request('lokasi_filter') == '2' ? 'selected' : ''); ?>>Lokasi 23 (KRISANTHIUM)</option>
                                    <option value="3" <?php echo e(request('lokasi_filter') == '3' ? 'selected' : ''); ?>>Lokasi 15 (BERBEK)</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                ...
                                <select class="form-select form-control" name="status_filter">
                                    ...
                                    <option value="belum_keluar" <?php echo e(request('status_filter') == 'belum_keluar' ? 'selected' : ''); ?>>Belum Keluar</option>
                                    <option value="sudah_keluar" <?php echo e(request('status_filter') == 'sudah_keluar' ? 'selected' : ''); ?>>Sudah Keluar</option>
                                    <option value="lengkap" <?php echo e(request('status_filter') == 'lengkap' ? 'selected' : ''); ?>>Lengkap</option>
                                </select>
                            </div>
                            <div class="col">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-between">
                    <div>
                        <a href="<?php echo e(route('security.goods-movement.create')); ?>" class="btn btn-success">
                            <i class="mdi mdi-plus"></i> Tambah Data
                        </a>
                        <a href="<?php echo e(route('security.goods-movement.export')); ?><?php echo e(request()->getQueryString() ? '?' . request()->getQueryString() : ''); ?>"
                            class="btn btn-info" target="_blank">
                            <i class="mdi mdi-file-pdf"></i> Export PDF
                        </a>
                        <a href="<?php echo e(route('security.goods-movement.export-excel')); ?><?php echo e(request()->getQueryString() ? '?' . request()->getQueryString() : ''); ?>"
                            class="btn btn-success">
                            <i class="mdi mdi-file-excel"></i> Export Excel
                        </a>
                    </div>
                    <div>
                        <span class="badge bg-info fs-6" style="color: white;">Total: <?php echo e($movements->total()); ?> data</span>
                        <?php
                        ...
                        ?>
                        <span class="badge bg-warning fs-6 ms-2" style="color: white;">Belum Keluar: <?php echo e($totalIn); ?></span>
                        <span class="badge bg-success fs-6 ms-2" style="color: white;">Lengkap: <?php echo e($totalComplete + $totalOut); ?></span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table id="goodsMovementTable" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $movements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-center"><?php echo e($movement->no_urut); ?></td>
                                            <td>
                                                <small
                                                    class="text-muted"><?php echo e(\Carbon\Carbon::parse($movement->tanggal)->locale('id')->isoFormat('dddd')); ?></small><br>
                                                <?php echo e(\Carbon\Carbon::parse($movement->tanggal)->format('d/m/Y')); ?>

                                            </td>
                                            <td>
                                                <strong><?php echo e($movement->nama_pengunjung); ?></strong>
                                            </td>
                                            <td>
                                                <?php if($movement->perusahaan_asal): ?>
                                                    <small class="text-muted"><?php echo e($movement->perusahaan_asal); ?></small>
                                                <?php else: ?>
                                                    <span class="text-muted">-</span>
                                                <?php endif; ?>
                                            </td>
                                            <td class="text-center">
                                                <?php if($movement->status_laporan == 'IN' && !$movement->jam_keluar): ?>
                                                    <span class="badge bg-warning text-white">
                                                        <i class="mdi mdi-clock-in"></i> IN - Belum Keluar
                                                    </span>
                                                    <br><small class="text-muted">Perlu update jam keluar</small>
                                                <?php elseif($movement->status_laporan == 'IN' && $movement->jam_keluar): ?>
                                                    <span class="badge bg-info text-white">
                                                        <i class="mdi mdi-clock-in"></i> IN - Sudah Keluar
                                                    </span>
                                                    <br><small class="text-muted">Lengkap</small>
                                                <?php elseif($movement->status_laporan == 'OUT'): ?>
                                                    <span class="badge bg-info text-white">
                                            ...
                                            <td>
                                                <small><strong><?php echo e(strlen($movement->jenis_barang) > 30 ? substr($movement->jenis_barang, 0, 30) . '...' : $movement->jenis_barang); ?></strong></small>
                                                <?php if($movement->deskripsi_barang): ?>
                                                    <br><small
                                                        class="text-muted"><?php echo e(strlen($movement->deskripsi_barang) > 40 ? substr($movement->deskripsi_barang, 0, 40) . '...' : $movement->deskripsi_barang); ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td class="text-center">
                                                <?php if($movement->jumlah): ?>
                                                    ...
                                                    <?php if($movement->satuan): ?>
                                                        <br><small class="text-muted"><?php echo e($movement->satuan); ?></small>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <span class="text-muted">-</span>
                                                <?php endif; ?>
                                            ...
                                            <td class="text-center">
                                                <?php if($movement->jam_masuk): ?>
                                                    <div class="mb-1">
                                                        <span class="badge bg-success text-white">
                                                            <i class="mdi mdi-clock-in"></i> <?php echo e(\Carbon\Carbon::parse($movement->jam_masuk)->format('H:i')); ?>
                                                ...
                                                <?php if($movement->jam_keluar): ?>
                                                    <div>
                                                        <span class="badge bg-info text-white">
                                                            <i class="mdi mdi-clock-out"></i> <?php echo e(\Carbon\Carbon::parse($movement->jam_keluar)->format('H:i')); ?>

                                                        </span>
                                                        <br><small class="text-muted">Keluar</small>
                                                    </div>
                                                <?php elseif($movement->status_laporan == 'IN'): ?>
                                                    <div class="mt-1">
                                                        <span class="badge bg-warning text-white">
                                            ...
                                            <td>
                                                <?php if($movement->jenis_kendaraan): ?>
                                                    <small><?php echo e($movement->jenis_kendaraan); ?></small>
                                                    <?php if($movement->no_polisi): ?>
                                                        <br><small class="text-muted"><?php echo e($movement->no_polisi); ?></small>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <span class="text-muted">-</span>
                                                <?php endif; ?>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="<?php echo e(route('security.goods-movement.show', $movement->id)); ?>"
                                                        class="btn btn-sm btn-outline-info" title="Detail">
                                                        <i class="mdi mdi-eye"></i>
                                                    </a>
                                                    <a href="<?php echo e(route('security.goods-movement.edit', $movement->id)); ?>"
                                                        class="btn btn-sm btn-outline-warning" title="Edit">
                                                        <i class="mdi mdi-pencil"></i>
                                                    </a>
                                                    <?php if(!$movement->jam_keluar && $movement->status_laporan == 'IN'): ?>
                                                        <a href="<?php echo e(route('security.goods-movement.edit', $movement->id)); ?>?mode=update-jam-keluar"
            ...
            function confirmDelete(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        // AJAX Delete
                        fetch(`<?php echo e(route('security.goods-movement.index')); ?>/${id}`, {
                                method: 'DELETE',
                                headers: {
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/security/goods-movement/index.blade.php ENDPATH**/ ?>