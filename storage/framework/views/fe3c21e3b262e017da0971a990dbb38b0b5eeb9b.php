                        ...
                        <div class="mb-3">
                            <?php if($request->status === 'pending'): ?>
                                <button type="button" class="btn btn-warning fs-6 w-100">
                                    <i class="mdi mdi-clock me-1"></i><?php echo e($request->status_label); ?>

                                </button>
                            <?php elseif($request->status === 'hr_approved'): ?>
                                <button type="button" class="btn btn-success fs-6 w-100">
                                    <i class="mdi mdi-check-circle me-1"></i><?php echo e($request->status_label); ?>

                                </button>
                            <?php elseif(str_contains($request->status, 'rejected')): ?>
                                <button type="button" class="btn btn-danger fs-6 w-100">
                                    <i class="mdi mdi-close-circle me-1"></i><?php echo e($request->status_label); ?>

                                </button>
                            <?php else: ?>
                                <button type="button" class="btn btn-info fs-6 w-100">
                                    <i class="mdi mdi-information me-1"></i><?php echo e($request->status_label); ?>
                            ...
                            <table class="table table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-info text-white"><?php echo e($request->request_type_label); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="40%" class="bg-light">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($request->employee->jabatanUser->jabatan ?? 'N/A'); ?></td>
                                    </tr>
                                    <tr>
                                        <td width="40%" class="bg-light">
                                            <strong>Bagian/Divisi</strong>
                                        </td>
                                        <td><?php echo e($request->employee->divisiUser->divisi ?? 'N/A'); ?></td>
                                    </tr>
                                    <tr>
                                        <td width="40%" class="bg-light">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-light text-dark"><?php echo e($request->days_since_created); ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if($request->replacement_person_name): ?>
                                        <tr>
                                            <td width="40%" class="bg-light">
                                                <strong>Pelaksana Tugas</strong>
                                            </td>
                                            <td>
                                                <?php echo e($request->replacement_person_name); ?>

                                                <?php if($request->replacement_person_nip): ?>
                                                    <small
                                                        class="text-muted">(<?php echo e($request->replacement_person_nip); ?>)</small>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                    ...
                                    <?php if(
                                        ...
                                        <?php
                                            $workGroupData = $request->employee
                                                ...
                                                : null;
                                        ?>
                                        <?php if($workGroupData): ?>
                                            <tr>
                                                <td width="40%" class="bg-light">
                                                    <strong>Kode Group</strong>
                                                </td>
                                                <td>
                                                    <p><?php echo e($workGroupData->{'Kode Group'}); ?></p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="40%" class="bg-light">
                                                ...
                                                <td>
                                                    <p><?php echo e($workGroupData->{'Nama Group'} ?? '-'); ?></p>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                    <?php endif; ?>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php if(isset($approvalFlow) && count($approvalFlow) > 0): ?>
                                    <div class="d-flex flex-column gap-3">
                                        <?php $__currentLoopData = $approvalFlow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $flow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-shrink-0 me-3">
                                                    ...
                                                    <div class="rounded-circle d-inline-flex align-items-center justify-content-center"
                                                        ...
                                                        <?php if($isCompleted): ?> background: linear-gradient(135deg, #28a745, #20c997);
                                                        <?php elseif($isPending): ?>
                                                            background: linear-gradient(135deg, #ffc107, #ff9800);
                                                        <?php else: ?>
                                                            background: #e9ecef; <?php endif; ?>
                                                        ">
                                                        <span
                                                            class="fw-bold
                                                            <?php if($isCompleted): ?> text-white
                                                            <?php elseif($isPending): ?>
                                                                text-dark
                                                            <?php else: ?>
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div
                                                        class="card
                                                        <?php if($isCompleted): ?> border-success
                                                        <?php elseif($isPending): ?>
                                                            border-warning
                                                        <?php else: ?>
                                                            border-light <?php endif; ?>
                                                    ">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div>
                                                                    ...
                                                                    ">
                                                                        <i
                                                                            class="mdi
                                                                            <?php if($flow->role_key === 'spv_division'): ?> mdi-account-tie
                                                                            <?php elseif($flow->role_key === 'head_division'): ?>
                                                                                mdi-account-star
                                                                            <?php elseif($flow->role_key === 'manager'): ?>
                                                                                mdi-account-key
                                                                            <?php elseif($flow->role_key === 'general_manager'): ?>
                                                                                mdi-account-supervisor
                                                                            <?php elseif($flow->role_key === 'hr'): ?>
                                                                                mdi-account-check
                                                                            <?php else: ?>
                                                                                mdi-account <?php endif; ?>
                                                                        me-1"></i>
                                                                        <?php echo e($flow->description ?? strtoupper(str_replace('_', ' ', $flow->role_key))); ?>

                                                                    </h6>
                                                                    <small class="text-muted">
                                                                        Order: <?php echo e($flow->approval_order); ?>

                                                                        <?php if($flow->role_key): ?>
                                                                            | Role: <?php echo e($flow->role_key); ?>
            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $request->overtimeEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><strong><?php echo e($employee->employee_name); ?></strong></td>
                                                <td><?php echo e($employee->department); ?></td>
                                                <td><span
                                                        class="badge bg-light text-dark"><?php echo e($employee->time_range); ?></span>
                                                </td>
                                        ...
                                        <?php $__currentLoopData = $request->formatted_request_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td width="35%" class="bg-light">
                                                    <strong><i
                                                            class="mdi mdi-chevron-right me-2 text-primary"></i><?php echo e($key); ?></strong>
                                                </td>
                                                <td><?php echo e($value); ?></td>
                                            </tr>
                                            
                                            <?php if(isset($newShiftData) && str_contains($key, 'Jam Baru')): ?>
                                                <tr>
                                                    <td width="35%" class="bg-light">
                                                    ...
                                                    <td>
                                                        <?php if($newShiftData): ?>
                                                            <?php echo e($newShiftData->{'Kode Shift'} ?? '-'); ?> -
                                                            <strong><?php echo e($newShiftData->{'Nama Shift'} ?? '-'); ?></strong>
                                                            <span class="text-muted ms-2">
                                                                (<?php echo e($newShiftData->{'Jam In'} ?? '-'); ?> -
                                                                <?php echo e($newShiftData->{'Jam Out'} ?? '-'); ?>)
                                                            </span>
                                                        <?php else: ?>
                                                            <span class="text-danger">
                                                                <i class="mdi mdi-alert-circle"></i>
                                                                Tidak ada shift yang sesuai dengan jam
                                                                <?php echo e($request->request_data['new_start_time'] ?? '-'); ?> -
                                                                <?php echo e($request->request_data['new_end_time'] ?? '-'); ?>
                                            ...
                                            <?php if(isset($exchangeFromShiftData) && str_contains($key, 'Jam Pemohon')): ?>
                                                <tr>
                                                    <td width="35%" class="bg-light"></td>
                                                    <td>
                                                        <?php if($exchangeFromShiftData): ?>
                                                            <?php echo e($exchangeFromShiftData->{'Kode Shift'} ?? '-'); ?> -

                                                            <strong><?php echo e($exchangeFromShiftData->{'Nama Shift'} ?? '-'); ?></strong>
                                                            <span class="text-muted ms-2">
                                                                (<?php echo e($exchangeFromShiftData->{'Jam In'} ?? '-'); ?> -
                                                                <?php echo e($exchangeFromShiftData->{'Jam Out'} ?? '-'); ?>)
                                                            </span>
                                                        <?php else: ?>
                                                            <span class="text-danger">
                                                                <i class="mdi mdi-alert-circle"></i>
                                            ...
                                            <?php if(isset($scheduleData) && str_contains($key, 'Jam Pemohon')): ?>
                                                <?php if($scheduleData): ?>
                                                        ...
                                                        <td>
                                                            <ul class="list-unstyled mb-0">
                                                                <li><strong>Tanggal:</strong>
                                                                    <?php echo e(\Carbon\Carbon::parse($scheduleData->Tgl)->format('d/m/Y')); ?>

                                                                </li>
                                                                <li><strong>Kode Group:</strong>
                                                                    <?php echo e($scheduleData->{'Kode Group'}); ?></li>
                                                                <li><strong>Kode Shift:</strong>
                                                                    <?php echo e($scheduleData->{'Kode Shift'} ?? '-'); ?></li>
                                                                <li><strong>Jam Shift:</strong>
                                                                    <?php echo e($scheduleData->{'Jam In'} ?? '-'); ?> -
                                                                    <?php echo e($scheduleData->{'Jam Out'} ?? '-'); ?></li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                <?php else: ?>
                                                    <tr class="table-warning">
                                                        ...
                                                        <td>
                                                            <span class="text-danger">
                                                                ...
                                                                <strong><?php echo e($requesterWorkGroupData ? $requesterWorkGroupData->{'Kode Group'} : '-'); ?></strong>
                                                                pada tanggal
                                                                <strong><?php echo e(\Carbon\Carbon::parse($request->request_data['date'])->format('d/m/Y')); ?></strong>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                            ...
                                            <?php if(isset($exchangeToShiftData) && str_contains($key, 'Jam Pengganti')): ?>
                                                <tr>
                                                    <td width="35%" class="bg-light"></td>
                                                    <td>
                                                        <?php if($exchangeToShiftData): ?>
                                                            <?php echo e($exchangeToShiftData->{'Kode Shift'} ?? '-'); ?> -

                                                            <strong><?php echo e($exchangeToShiftData->{'Nama Shift'} ?? '-'); ?></strong>
                                                            <span class="text-muted ms-2">
                                                                (<?php echo e($exchangeToShiftData->{'Jam In'} ?? '-'); ?> -
                                                                <?php echo e($exchangeToShiftData->{'Jam Out'} ?? '-'); ?>)
                                                            </span>
                                                        <?php else: ?>
                                                            <span class="text-danger">
                                                                <i class="mdi mdi-alert-circle"></i>
                                            ...
                                            <?php if(str_contains($key, 'Keperluan Pengganti')): ?>
                                                <?php if(isset($partnerScheduleData) && $partnerScheduleData): ?>
                                                    <tr class="table-info">
                                                        <td width="35%">
                                                            <strong><i
                                                        ...
                                                        <td>
                                                            <ul class="list-unstyled mb-0">
                                                                <li><strong>Tanggal:</strong>
                                                                    <?php echo e(\Carbon\Carbon::parse($partnerScheduleData->Tgl)->format('d/m/Y')); ?>

                                                                </li>
                                                                <li><strong>Kode Group:</strong>
                                                                    <?php echo e($partnerScheduleData->{'Kode Group'}); ?></li>
                                                                <li><strong>Kode Shift:</strong>
                                                                    <?php echo e($partnerScheduleData->{'Kode Shift'} ?? '-'); ?></li>
                                                                <li><strong>Jam Shift:</strong>
                                                                    <?php echo e($partnerScheduleData->{'Jam In'} ?? '-'); ?> -
                                                                    <?php echo e($partnerScheduleData->{'Jam Out'} ?? '-'); ?></li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                <?php else: ?>
                            ...
                            <div class="alert alert-warning mt-3">
                                ...
                                <ul class="mb-0">
                                    <li><strong>Tanggal Kerja:</strong>
                                        <?php echo e(\Carbon\Carbon::parse($request->request_data['holiday_work_date'] ?? ($request->request_data['date'] ?? '-'))->format('d/m/Y')); ?>

                                    </li>
                                    <li><strong>Jam Kerja:</strong>
                                        <?php echo e($request->request_data['applicant_start_time'] ?? '-'); ?> -
                                        <?php echo e($request->request_data['applicant_end_time'] ?? '-'); ?></li>
                        ...
                        <?php if(($request->status === 'head_approved' || $request->status === 'manager_approved' || !is_null($request->head_approved_at) || !is_null($request->manager_approved_at)) && ($request->request_type === 'absence')): ?>
                            <?php
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if($syncStatus === 'sudah_sinkron'): ?>
                                        <div class="alert alert-success">
                                            <i class="mdi mdi-check-circle me-2"></i>
                                            <strong>Data sudah berhasil disinkronkan ke Payroll.</strong>
                                            <br>
                                            <small class="text-muted"><?php echo e($syncMessage); ?></small>
                                        </div>
                                    <?php else: ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="approvalForm" method="POST"
                                        action="<?php echo e(route('hr.approval.process', $request->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="redirect_url" value="<?php echo e(route($backRoute)); ?>">
                                        <div class="row mb-3">
                                            <div class="col-12">
                                        ...
                                        <?php if($shouldShowReplacementForm): ?>
                                            <div class="row mb-3">
                                                <div class="col-12">
                                            ...
                                            <div class="row mb-3">
                                                    ...
                                                    <select name="replacement_person_id" id="replacement_person_id"
                                                        ...
                                                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($emp->id); ?>"
                                                                data-name="<?php echo e($emp->name); ?>" data-nip=""
                                                                <?php echo e(old('replacement_person_id') == $emp->id ? 'selected' : ''); ?>>
                                                                <?php echo e($emp->name); ?>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="replacement_person_name"
                                                        ...
                                                        value="<?php echo e(old('replacement_person_name')); ?>">
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if(auth()->user()->isHR() && $request->request_type === 'absence'): ?>
                                            <?php
                                                    ...
                                                    <div class="card border border-info bg-light">
                                                        <div class="card-body">
                                                            <h6 class="card-title fw-bold text-info mb-3">
                                                                ...
                                                                <small class="text-muted">(Default dari masterijin: <?php echo e($simulatedJenisIjin ?? 'I'); ?>)</small>
                                                            </h6>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" type="checkbox"
                                                                               ...
                                                                               <?php echo e($checkedGajiDibayar ? 'checked' : ''); ?>

                                                                               disabled
                                                                               style="opacity: 1; cursor: not-allowed;">
                                                                        <input type="hidden" name="gaji_dibayar" value="<?php echo e($checkedGajiDibayar ? '1' : '0'); ?>">
                                                                        <label class="form-check-label" for="gaji_dibayar_display" style="cursor: default;">
                                                                            <strong>Gaji Dibayar</strong>
                                                                            <?php if($checkedGajiDibayar): ?>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-check form-switch">
                                                                        <input class="form-check-input" type="checkbox"
                                                                               ...
                                                                               <?php echo e($checkedPotongCuti ? 'checked' : ''); ?>

                                                                               disabled
                                                                               style="opacity: 1; cursor: not-allowed;">
                                                                        <input type="hidden" name="potong_cuti" value="<?php echo e($checkedPotongCuti ? '1' : '0'); ?>">
                                                                        <label class="form-check-label" for="potong_cuti_display" style="cursor: default;">
                                                                            <strong>Potong Cuti</strong>
                                                                            <?php if($checkedPotongCuti): ?>
                                                                                <span class="badge bg-success ms-2">Ya</span>
                                                                            <?php else: ?>
            ...
            $('.disapprove-btn').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '<?php echo e(route('hr.approval.disapprove', ':id')); ?>'.replace(':id',
                                requestId),
                            method: 'POST',
                            headers: {
                                'X-Requested-With': 'XMLHttpRequest',
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/approval/show.blade.php ENDPATH**/ ?>