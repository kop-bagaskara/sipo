    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('hr.spl.store')); ?>" method="POST" id="splForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="shift" class="form-select form-control <?php $__errorArgs = ['shift'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="1" <?php echo e(old('shift') == '1' ? 'selected' : ''); ?>>1 (Pagi)</option>
                                    <option value="2" <?php echo e(old('shift') == '2' ? 'selected' : ''); ?>>2 (Siang)</option>
                                    <option value="3" <?php echo e(old('shift') == '3' ? 'selected' : ''); ?>>3 (Malam)</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('start_time')); ?>" placeholder="Contoh: 18:00" required>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('end_time')); ?>" placeholder="Contoh: 22:00" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="mesin" class="form-control <?php $__errorArgs = ['mesin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('mesin')); ?>" placeholder="Contoh: Mesin CNC-01">
                                <?php $__errorArgs = ['mesin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" rows="3"
                                          placeholder="Contoh: Selesaikan target produksi batch 123 yang harus dikirim besok..." required><?php echo e(old('keperluan')); ?></textarea>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="employees-table">
                                ...
                                <tbody id="employees-tbody">
                                    <!-- Default 2 rows -->
                                    <?php for($i = 0; $i < 2; $i++): ?>
                                        <tr data-index="<?php echo e($i); ?>" class="employee-row-<?php echo e($i); ?>">
                                            ...
                                            <td>
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-control form-select form-select-sm employee-select" data-index="<?php echo e($i); ?>">
                                                        <option value="">-- Pilih dari Master Employee --</option>
                                                        <?php $__currentLoopData = $payrollEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($emp->Nip); ?>"
                                                                    data-name="<?php echo e($emp->Nama); ?>"
                                                                    data-nip="<?php echo e($emp->Nip); ?>">
                                                                <?php echo e($emp->Nama); ?> (<?php echo e($emp->Nip); ?>)
                                                            </option>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-control form-select form-select-sm user-select" data-index="<?php echo e($i); ?>">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" name="employees[<?php echo e($i); ?>][employee_name]"
                                                           class="form-control form-control-sm employee-name <?php $__errorArgs = ['employees.'.$i.'.employee_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <input type="hidden" name="employees[<?php echo e($i); ?>][employee_id]" class="employee-id">
                                                <input type="hidden" name="employees[<?php echo e($i); ?>][nip]" class="employee-nip">
                                                <input type="hidden" name="employees[<?php echo e($i); ?>][is_manual]" class="is-manual" value="false">
                                                <div class="d-flex justify-content-between align-items-center mt-2">
                                                    <small class="text-muted">
                                                        <i class="mdi mdi-information-outline"></i>
                                                        Pilih dari dropdown atau tulis manual
                                                    </small>
                                                    <span class="badge bg-secondary employee-status-badge-<?php echo e($i); ?> d-none">
                                                        <i class="mdi mdi-pencil"></i> Manual
                                                    </span>
                                                    <span class="badge bg-success employee-selected-badge-<?php echo e($i); ?> d-none">
                                                        <i class="mdi mdi-check-circle"></i> Terpilih
                                                    </span>
                                                </div>
                                                <?php $__errorArgs = ['employees.'.$i.'.employee_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <td class="text-center">
                                                <?php if($i > 0): ?>
                                                    <button type="button" class="btn btn-sm btn-danger remove-employee-row" data-index="<?php echo e($i); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus baris ini">
                        ...
                        <div class="row">
                            <div class="col-12 text-end">
                                <a href="<?php echo e(route('hr.spl.index')); ?>" class="btn btn-secondary">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        let employeeIndex = <?php echo e(count(old('employees', [])) > 0 ? count(old('employees', [])) : 2); ?>;
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/hr/spl/create.blade.php ENDPATH**/ ?>