                ...
                <div class="card">
                    <div class="card-body" id="dashboardTabs">
                        ...
                        <?php if(auth()->user()->divisi == 11): ?>
                            <a href="<?php echo e(route('dashboard.security')); ?>"
                                class="nav-link active btn btn-info mb-2 w-100 text-left" id="security-tab"
                                data-bs-toggle="tab" data-bs-target="#security" type="button" role="tab"
                                aria-controls="security" aria-selected="true">
                                <i class="mdi mdi-shield-account mr-2"></i>
                                Dashboard Security
                            </a>
                        <?php elseif(auth()->user()->divisi != 8): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="nav-link btn btn-info mb-2 w-100 text-left"
                            ...
                            <a href="<?php echo e(route('dashboard.ppic')); ?>" class="nav-link btn btn-info mb-2 w-100 text-left"
                                id="ppic-tab" data-bs-toggle="tab" data-bs-target="#ppic" type="button" role="tab"
                                aria-controls="ppic" aria-selected="false">
                                <i class="mdi mdi-view-dashboard mr-2"></i>
                                Dashboard PPIC
                            </a>

                            <a href="<?php echo e(route('dashboard.prepress')); ?>" class="nav-link btn btn-info mb-2 w-100 text-left"
                                id="prepress-tab" data-bs-toggle="tab" data-bs-target="#prepress" type="button"
                                role="tab" aria-controls="prepress" aria-selected="false">
                                <i class="mdi mdi-view-dashboard mr-2"></i>
                                Dashboard Prepress
                            </a>
                        ...
                        <?php if(auth()->user()->divisi == 1): ?>
                            ...
                            <a href="<?php echo e(route('dashboard.security')); ?>" class="nav-link active btn btn-info mb-2 w-100 text-left"
                                id="security-tab" data-bs-toggle="tab" data-bs-target="#security" type="button"
                                role="tab" aria-controls="security" aria-selected="true">
                                                ...
                                                <div class="card-header bg-info text-white">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <h4 class="card-title mb-0 text-white">
                                                            <i class="mdi mdi-shield-account mr-2"></i>
                                                            Dashboard Keamanan - <?php echo e(auth()->user()->name); ?>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="card bg-warning text-white">
                                                                <div class="card-body text-center">
                                                                    <h3 class="mb-0" id="securityCompletedChecklists">0
                                                                    </h3>
                                                                    <small>Selesai</small>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="card bg-info text-white">
                                                                <div class="card-body text-center">
                                                                    <h3 class="mb-0" id="securityPendingChecklists">0
                                                                    </h3>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-2">
                                                                            <a href="<?php echo e(route('security.vehicle-checklist.create')); ?>"
                                                                                class="btn btn-primary btn-block">
                                                                                <i class="mdi mdi-plus"></i> Daftar Periksa
                                                                                Kendaraan
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <a href="<?php echo e(route('security.goods-movement.create')); ?>"
                                                                                class="btn btn-success btn-block">
                                                                                <i class="mdi mdi-truck"></i> Pergerakan
                                                                                Barang
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <a href="<?php echo e(route('security.daily-activity.create')); ?>"
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <a href="<?php echo e(route('hr.reports.security')); ?>"
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <a href="<?php echo e(route('hr.security-master.index')); ?>"
        ...
        <script>
            ...
            function updateAttentionJobsList(attentionJobs) {
                ...
                attentionJobs.forEach(function(job) {
                    ...
                    const itemClass = job.priority === 'Urgent' ? 'urgent' : (job.priority === 'High' ?
                        'high-priority' : '');
            ...
            function updatePrepressDashboard(data) {
                ...
                const marketingJobsInProgress = (data.departments?.marketing?.jobs || []).filter(job => job.status ===
                    'in_progress');
            ...
            function performSearch(searchTerm) {
                ...
                const marketingJobs = prepressDataCache.departments?.marketing?.all_jobs || prepressDataCache.departments
                    ?.marketing?.jobs || [];
                const othersJobs = prepressDataCache.departments?.others?.all_jobs || prepressDataCache.departments?.others
                    ?.jobs || [];
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/dashboards/dashboard-security.blade.php ENDPATH**/ ?>