        ...
        <script>
            $(document).ready(function() {
                ...
                var datatable = $('#datatable-divisi').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(route('master.divisi-data')); ?>",
                        type: "POST",
                        data: function(d) {
                ...
                var routeSubmitUser = "<?php echo e(route('master.divisi-data-submit')); ?>";
                ...
                var routeEditUser = "<?php echo e(route('master.divisi-data-detail', ['id' => 'ID_PLACEHOLDER'])); ?>";
                ...
                $('body').on('click', '.delete-data', function() {
                    var id = $(this).data('id');
                    var url = "<?php echo e(route('master.delete-master-divisi-data', ['id' => 'ID_PLACEHOLDER'])); ?>";
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/master/master-divisi.blade.php ENDPATH**/ ?>