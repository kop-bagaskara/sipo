    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-forecast').on('click', function() {
                window.location.href = "<?php echo e(route('forecasting.list')); ?>";
            });
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/forecasting/index.blade.php ENDPATH**/ ?>