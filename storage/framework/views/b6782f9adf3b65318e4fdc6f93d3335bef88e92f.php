        ...
        <div class="report-info">
            <table>
                <tr>
                    ...
                    <td><?php echo e($log->hari_formatted); ?>, <?php echo e($log->tanggal->format('d F Y')); ?></td>
                    <td class="label">Shift / Jam:</td>
                    <td><?php echo e($log->shift_formatted); ?> / <?php echo e($log->jam_mulai_formatted); ?> - <?php echo e($log->jam_selesai_formatted); ?></td>
                </tr>
                <tr>
                    <td class="label">Personil Jaga:</td>
                    <td><?php echo e($log->personil_jaga); ?></td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php if($entry->time_in_formatted): ?>
                                <?php echo e($entry->time_in_formatted); ?>
                        ...
                        <td class="text-center">
                            <?php if($entry->time_out_formatted): ?>
                                <?php echo e($entry->time_out_formatted); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="summary-card">
                        <h4>Kondisi Awal</h4>
                        <p><?php echo e($log->kondisi_awal ?: 'Tidak ada catatan kondisi awal'); ?></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="summary-card">
                        <h4>Kondisi Akhir</h4>
                        <p><?php echo e($log->kondisi_akhir ?: 'Tidak ada catatan kondisi akhir'); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="signature-table">
                <tr>
                    <td>
                        ...
                        <p><strong><?php echo e($log->menyerahkan_by ?: '________________'); ?></strong></p>
                    </td>
                    <td>
                        <h4>Diterima</h4>
                        <div class="signature-line"></div>
                        <p><strong><?php echo e($log->diterima_by ?: '________________'); ?></strong></p>
                    </td>
                    <td>
                        <h4>Diketahui</h4>
                        <div class="signature-line"></div>
                        <p><strong><?php echo e($log->diketahui_by ?: '________________'); ?></strong></p>
                    </td>
                </tr>
            </table>

            <div class="footer">
                <p>Surabaya, <?php echo e($log->tanggal->format('d F Y')); ?></p>
...
<?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/security/daily-activity/export.blade.php ENDPATH**/ ?>