    ...
    <?php $__env->startSection('content'); ?>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body" id="dashboardTabs">
                        ...
                        <a href="<?php echo e(route('dashboard.security')); ?>" class="nav-link active btn btn-info mb-2 w-100 text-left" id="security-tab" data-bs-toggle="tab"
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="nav-link btn btn-info mb-2 w-100 text-left" id="overview-tab" data-bs-toggle="tab"
                        ...
                        <a href="<?php echo e(route('dashboard.ppic')); ?>" class="nav-link btn btn-info mb-2 w-100 text-left" id="ppic-tab" data-bs-toggle="tab"
                            data-bs-target="#ppic" type="button" role="tab" aria-controls="ppic" aria-selected="false">
                            <i class="mdi mdi-view-dashboard mr-2"></i>
                            Dashboard PPIC
                        </a>

                        <a href="<?php echo e(route('dashboard.prepress')); ?>" class="nav-link active btn btn-info mb-2 w-100 text-left" id="prepress-tab" data-bs-toggle="tab"
                        ...
                        <a href="<?php echo e(route('dashboard.security')); ?>" class="nav-link btn btn-info mb-2 w-100 text-left" id="security-tab" data-bs-toggle="tab"
                            data-bs-target="#security" type="button" role="tab" aria-controls="security"
                            aria-selected="true">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h4>Welcome to the Dashboard! <?php echo e(auth()->user()->name); ?>,
                            <?php echo e($user->divisi_name ?? '-'); ?></h4>
                                                        ...
                                                        <div class="card prepress-stat-card">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0 font-weight-bold" id="stat-finish">
                                                                    <?php echo e($prepressData['stats']['finish'] ?? 0); ?></h3>
                                                                <small>Finish</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card prepress-stat-card">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0 font-weight-bold" id="stat-in-progress">
                                                                    <?php echo e($prepressData['stats']['in_progress'] ?? 0); ?></h3>
                                                        ...
                                                        <div class="card prepress-stat-card">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0 font-weight-bold" id="stat-assigned">
                                                                    <?php echo e($prepressData['stats']['assigned'] ?? 0); ?></h3>
                                                        ...
                                                        <div class="card prepress-stat-card">
                                                            <div class="card-body text-center">
                                                                <h3 class="mb-0 font-weight-bold" id="stat-approved">
                                                                    <?php echo e($prepressData['stats']['approved'] ?? 0); ?></h3>
                                                        ...
                                                        <div class="card border-left-primary">
                                                            <div class="card-header bg-info text-white">
                                                                <h5 class="card-title mb-0 text-white">
                                                                    ...
                                                                    <span
                                                                        class="badge badge-light ml-2" id="marketing-total"><?php echo e($prepressData['departments']['marketing']['stats']['total'] ?? 0); ?></span>
                                                                </h5>
                                                            </div>
                                                                    ...
                                                                    <table class="table table-hover mb-0">
                                                                        ...
                                                                        <tbody id="marketing-stats-body">
                                                                            <tr>
                                                                                ...
                                                                                <td id="marketing-finish"><?php echo e($prepressData['departments']['marketing']['stats']['finish'] ?? 0); ?>

                                                                                </td>
                                                                                <td id="marketing-finish-pct">
                                                                                    <?php if(($prepressData['departments']['marketing']['stats']['total'] ?? 0) > 0): ?>
                                                                                        <?php echo e(round((($prepressData['departments']['marketing']['stats']['finish'] ?? 0) / ($prepressData['departments']['marketing']['stats']['total'] ?? 1)) * 100, 1)); ?>%
                                                                                    <?php else: ?>
                                                                                        0%
                                                                                    <?php endif; ?>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td id="marketing-in-progress"><?php echo e($prepressData['departments']['marketing']['stats']['in_progress'] ?? 0); ?>

                                                                                </td>
                                                                                <td id="marketing-in-progress-pct">
                                                                                    <?php if(($prepressData['departments']['marketing']['stats']['total'] ?? 0) > 0): ?>
                                                                                        <?php echo e(round((($prepressData['departments']['marketing']['stats']['in_progress'] ?? 0) / ($prepressData['departments']['marketing']['stats']['total'] ?? 1)) * 100, 1)); ?>%
                                                                                    <?php else: ?>
                                                                                        0%
                                                                                    <?php endif; ?>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td id="marketing-assigned"><?php echo e($prepressData['departments']['marketing']['stats']['assigned'] ?? 0); ?>

                                                                                </td>
                                                                                <td id="marketing-assigned-pct">
                                                                                    <?php if(($prepressData['departments']['marketing']['stats']['total'] ?? 0) > 0): ?>
                                                                                        <?php echo e(round((($prepressData['departments']['marketing']['stats']['assigned'] ?? 0) / ($prepressData['departments']['marketing']['stats']['total'] ?? 1)) * 100, 1)); ?>%
                                                                                    <?php else: ?>
                                                                                        0%
                                                                                    <?php endif; ?>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td id="marketing-approved"><?php echo e($prepressData['departments']['marketing']['stats']['approved'] ?? 0); ?>

                                                                                </td>
                                                                                <td id="marketing-approved-pct">
                                                                                    <?php if(($prepressData['departments']['marketing']['stats']['total'] ?? 0) > 0): ?>
                                                                                        <?php echo e(round((($prepressData['departments']['marketing']['stats']['approved'] ?? 0) / ($prepressData['departments']['marketing']['stats']['total'] ?? 1)) * 100, 1)); ?>%
                                                                                    <?php else: ?>
                                                                                        0%
                                                                                    <?php endif; ?>
                                                                                </td>
                                                        ...
                                                        <div class="card border-left-info">
                                                            <div class="card-header bg-info text-white">
                                                                <h5 class="card-title mb-0 text-white">
                                                                    ...
                                                                    Other Departments
                                                                    <span
                                                                        class="badge badge-light ml-2" id="others-total"><?php echo e($prepressData['departments']['others']['stats']['total'] ?? 0); ?></span>
                                                                </h5>
                                                            </div>
                                                            <div class="card-body p-0">
                                                                <div class="table-responsive">
                                                                    <table class="table table-hover mb-0">
                                                                        ...
                                                                        <tbody id="others-stats-body">
                                                                            <tr>
                                                                                ...
                                                                                <td id="others-finish"><?php echo e($prepressData['departments']['others']['stats']['finish'] ?? 0); ?>

                                                                                </td>
                                                                                <td id="others-finish-pct">
                                                                                    <?php if(($prepressData['departments']['others']['stats']['total'] ?? 0) > 0): ?>
                                                                                        <?php echo e(round((($prepressData['departments']['others']['stats']['finish'] ?? 0) / ($prepressData['departments']['others']['stats']['total'] ?? 1)) * 100, 1)); ?>%
                                                                                    <?php else: ?>
                                                                                        0%
                                                                                    <?php endif; ?>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td id="others-in-progress"><?php echo e($prepressData['departments']['others']['stats']['in_progress'] ?? 0); ?>

                                                                                </td>
                                                                                <td id="others-in-progress-pct">
                                                                                    <?php if(($prepressData['departments']['others']['stats']['total'] ?? 0) > 0): ?>
                                                                                        <?php echo e(round((($prepressData['departments']['others']['stats']['in_progress'] ?? 0) / ($prepressData['departments']['others']['stats']['total'] ?? 1)) * 100, 1)); ?>%
                                                                                    <?php else: ?>
                                                                                        0%
                                                                                    <?php endif; ?>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td id="others-assigned"><?php echo e($prepressData['departments']['others']['stats']['assigned'] ?? 0); ?>

                                                                                </td>
                                                                                <td id="others-assigned-pct">
                                                                                    <?php if(($prepressData['departments']['others']['stats']['total'] ?? 0) > 0): ?>
                                                                                        <?php echo e(round((($prepressData['departments']['others']['stats']['assigned'] ?? 0) / ($prepressData['departments']['others']['stats']['total'] ?? 1)) * 100, 1)); ?>%
                                                                                    <?php else: ?>
                                                                                        0%
                                                                                    <?php endif; ?>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td id="others-approved"><?php echo e($prepressData['departments']['others']['stats']['approved'] ?? 0); ?>

                                                                                </td>
                                                                                <td id="others-approved-pct">
                                                                                    <?php if(($prepressData['departments']['others']['stats']['total'] ?? 0) > 0): ?>
                                                                                        <?php echo e(round((($prepressData['departments']['others']['stats']['approved'] ?? 0) / ($prepressData['departments']['others']['stats']['total'] ?? 1)) * 100, 1)); ?>%
                                                                                    <?php else: ?>
                                                                                        0%
                                                                                    <?php endif; ?>
                                                                                </td>
                                                        ...
                                                        <div class="card border-left-primary mb-3">
                                                            ...
                                                            <div class="card-body p-0">
                                                                <div class="plan-items"
                                                                    ...
                                                                    <?php if(isset($prepressData['departments']['marketing']['jobs']) &&
                                                                            count($prepressData['departments']['marketing']['jobs']) > 0): ?>
                                                                        <?php $__currentLoopData = $prepressData['departments']['marketing']['jobs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php
                                                                                $statusColor = 'bg-info';
                                                                            ...
                                                                            <div class="d-flex align-items-center justify-content-between p-3 bg-light rounded mb-2 job-item <?php echo e($statusClass); ?>"
                                                                                style="margin: 10px;">
                                                                                <div class="d-flex align-items-center">
                                                                                    <div class="<?php echo e($statusColor); ?> rounded-circle mr-3"
                                                                                        style="width: 12px; height: 12px;">
                                                                                    </div>
                                                                                    <div style="min-width: 0; flex: 1;">
                                                                                        <h6
                                                                                            class="mb-0 font-size-14 text-truncate">
                                                                                            <?php echo e($job['nomor_job_order']); ?>

                                                                                        </h6>
                                                                                        <small
                                                                                            class="text-muted d-block"><?php echo e($job['product']); ?></small>
                                                                                        <small
                                                                                            class="text-success d-block">Customer:
                                                                                            <?php echo e($job['customer']); ?></small>
                                                                                        <?php if($job['job']): ?>
                                                                                            <small
                                                                                                class="text-info d-block">Job:
                                                                                                <?php echo e($job['job']); ?></small>
                                                                                        <?php endif; ?>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="text-right"
                                                                                    ...
                                                                                    <span
                                                                                        class="status-badge badge badge-<?php echo e($statusColor === 'bg-success' ? 'success' : ($statusColor === 'bg-warning' ? 'warning' : ($statusColor === 'bg-danger' ? 'danger' : 'secondary'))); ?>">
                                                                                    ...
                                                                                    <div class="mt-1">
                                                                                        <?php if($job['assignee']): ?>
                                                                                            <small
                                                                                                class="text-primary d-block"><?php echo e($job['assignee']); ?></small>
                                                                                        <?php endif; ?>
                                                                                        <?php if($job['est_waktu_job']): ?>
                                                                                            <small
                                                                                                class="text-muted d-block"><?php echo e($job['est_waktu_job']); ?>
                                                                                    ...
                                                                                    <div class="mt-1">
                                                                                        <span
                                                                                            class="<?php echo e($priorityClass); ?>">
                                                                                            <?php echo e($priorityIcon); ?>

                                                                                            <?php echo e($job['priority'] == 'Urgent' ? 'Urgent' : 'Normal'); ?>

                                                                                        </span>
                                                                                    </div>
                                                                                    <?php if($job['tanggal_deadline']): ?>
                                                                                        <small
                                                                                            class="text-warning d-block text-truncate"
                                                                                            style="max-width: 150px;">
                                                                                            Deadline:
                                                                                            <?php echo e(\Carbon\Carbon::parse($job['tanggal_deadline'])->format('d/m/Y H:i')); ?>
                                                                ...
                                                                <div class="plan-items"
                                                                    ...
                                                                    <?php
                                                                        $othersJobsInProgress = isset($prepressData['departments']['others']['jobs'])
                                                                            ...
                                                                            : [];
                                                                    ?>
                                                                    <?php if(count($othersJobsInProgress) > 0): ?>
                                                                        <?php $__currentLoopData = $othersJobsInProgress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php
                                                                                $statusColor = 'bg-info';
                                                                                $statusText = 'Processing';
                                                                                $statusClass = 'in-progress';
    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        <script>
            ...
            function loadSupplierData() {
                $.ajax({
                    url: '<?php echo e(route("supplier-tickets.dashboard-data")); ?>',
                    type: 'GET',
                    success: function(response) {
                        if (response.data) {
            ...
            function loadSupplierTickets() {
                $.ajax({
                    url: '<?php echo e(route("supplier-tickets.dashboard-tickets")); ?>',
                    type: 'GET',
                    success: function(response) {
                        if (response.tickets) {
            ...
            function loadSecurityData() {
                $.ajax({
                    url: '<?php echo e(route("security.dashboard-data")); ?>',
                    type: 'GET',
                    success: function(response) {
                        if (response.data) {
            ...
            function loadSecurityVehicleChecklists() {
                $.ajax({
                    url: '<?php echo e(route("security.vehicle-checklist.dashboard-data")); ?>',
                    type: 'GET',
                    success: function(response) {
            ...
            function loadSecurityGoodsMovements() {
                $.ajax({
                    url: '<?php echo e(route("security.goods-movement.dashboard-data")); ?>',
                    type: 'GET',
                    success: function(response) {
            ...
            function loadPrepressData(silent = false) {
                ...
                $.ajax({
                    url: "<?php echo e(route('api.dashboard.prepress-data')); ?>",
                    type: 'GET',
                    dataType: 'json',
                    headers: {
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/dashboards/dashboard-prepress.blade.php ENDPATH**/ ?>