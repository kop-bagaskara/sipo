                        ...
                        <div class="col-md-4">
                            ...
                            <select id="filter-divisi" class="form-control">
                                ...
                                <?php $__currentLoopData = $divisis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>"><?php echo e($item->divisi); ?></option>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="level" id="level" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" data-name="<?php echo e($item->level); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select name="divisi" id="divisi" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $divisis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" data-name="<?php echo e($item->divisi); ?>">
                                        <?php echo e($item->divisi); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="jabatan" id="jabatan" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $jabatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" data-name="<?php echo e($item->jabatan); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            var datatable = $('#datatable-user').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('master.user-data')); ?>",
                    type: "POST",
                    data: function(d) {
            ...
            var routeSubmitUser = "<?php echo e(route('master.user-data-submit')); ?>";
            var routeEditUser = "<?php echo e(route('master.user-data-detail', ['id' => 'ID_PLACEHOLDER'])); ?>";
            var routeDeleteUser = "<?php echo e(route('master.delete-master-user-data', ['id' => 'ID_PLACEHOLDER'])); ?>";
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/master/master-user.blade.php ENDPATH**/ ?>