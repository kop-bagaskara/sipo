<?php $__env->startSection('title'); ?>
    <?php echo e($mode == 'create' ? 'Tambah' : 'Edit'); ?> Forecast
    ...
    <?php $__env->startSection('content'); ?>
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor"><?php echo e($mode == 'create' ? 'Tambah' : 'Edit'); ?> Forecast</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('forecasting.index')); ?>">Forecasting</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo e(route('forecasting.list')); ?>">Forecast List</a></li>
                    <li class="breadcrumb-item active"><?php echo e($mode == 'create' ? 'Tambah' : 'Edit'); ?></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="<?php echo e($mode == 'create' ? route('forecasting.store') : route('forecasting.update', $forecast->id ?? '')); ?>" id="forecastForm">
                            <?php echo csrf_field(); ?>
                            <?php if($mode == 'edit'): ?>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control <?php $__errorArgs = ['customer_name'];
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="Unilever" <?php echo e(old('customer_name', $forecast->customer_name ?? '') == 'Unilever' ? 'selected' : ''); ?>>Unilever</option>
                                            <option value="Nabati" <?php echo e(old('customer_name', $forecast->customer_name ?? '') == 'Nabati' ? 'selected' : ''); ?>>Nabati</option>
                                            <option value="OTHERS" <?php echo e(old('customer_name', $forecast->customer_name ?? '') == 'OTHERS' ? 'selected' : ''); ?>>OTHERS</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="Januari" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'Januari' ? 'selected' : ''); ?>>Januari</option>
                                            <option value="Februari" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'Februari' ? 'selected' : ''); ?>>Februari</option>
                                            <option value="Maret" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'Maret' ? 'selected' : ''); ?>>Maret</option>
                                            <option value="April" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'April' ? 'selected' : ''); ?>>April</option>
                                            <option value="Mei" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'Mei' ? 'selected' : ''); ?>>Mei</option>
                                            <option value="Juni" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'Juni' ? 'selected' : ''); ?>>Juni</option>
                                            <option value="Juli" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'Juli' ? 'selected' : ''); ?>>Juli</option>
                                            <option value="Agustus" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'Agustus' ? 'selected' : ''); ?>>Agustus</option>
                                            <option value="September" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'September' ? 'selected' : ''); ?>>September</option>
                                            <option value="Oktober" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'Oktober' ? 'selected' : ''); ?>>Oktober</option>
                                            <option value="November" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'November' ? 'selected' : ''); ?>>November</option>
                                            <option value="Desember" <?php echo e(old('period_month', $forecast->period_month ?? '') == 'Desember' ? 'selected' : ''); ?>>Desember</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control <?php $__errorArgs = ['period_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                               ...
                                               value="<?php echo e(old('period_year', $forecast->period_year ?? date('Y'))); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                  ...
                                                  placeholder="Catatan tambahan"><?php echo e(old('notes', $forecast->notes ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="items-container">
                                <?php if($mode == 'edit' && isset($forecast) && $forecast->items->count() > 0): ?>
                                    <?php $__currentLoopData = $forecast->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="item-row" data-item-index="<?php echo e($index); ?>">
                                            <?php echo $__env->make('main.forecasting.partials.item-row', ['itemIndex' => $index, 'item' => $item, 'forecast' => $forecast], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    <!-- Default empty item row -->
                                    <div class="item-row" data-item-index="0">
                                        <?php echo $__env->make('main.forecasting.partials.item-row', ['itemIndex' => 0, 'item' => null, 'forecast' => $forecast ?? null], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group mt-4">
                                ...
                                <a href="<?php echo e(route('forecasting.list')); ?>" class="btn btn-secondary">
    ...
    <?php $__env->startSection('scripts'); ?>
        ...
        <script>
            $(document).ready(function() {
                let itemIndex = <?php echo e($mode == 'edit' && isset($forecast) ? $forecast->items->count() : 1); ?>;
...
<?php echo $__env->make('main.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sjm\sipo_krisan\resources\views/main/forecasting/form.blade.php ENDPATH**/ ?>